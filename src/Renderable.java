...
public abstract class Renderable extends DualNode {
	...
	static int method4715(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.GETWINDOWMODE) {
			...
			if (var0 == ScriptOpcodes.SETWINDOWMODE) {
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class10.clientPreferences
						.method2456();
				return 1;
	...
	static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (Client.loadInterface(var0)) {
			...
			TaskHandler.drawInterface(class16.Widget_interfaceComponents[var0], -1, var1, var2, var3, var4, var5, var6,
					var7);
			if (class134.field1575 != null) {
				TaskHandler.drawInterface(class134.field1575, -1412584499, var1, var2, var3, var4, class74.field911,
