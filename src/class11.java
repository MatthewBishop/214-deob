...
class class11 implements TlsAuthentication {
	...
	public void notifyServerCertificate(Certificate var1) throws IOException {
		try {
			...
			this.this$2.this$1.field59 = (java.security.cert.Certificate[]) ((java.security.cert.Certificate[]) var3
	...
	static void method105(GameEngine var0) {
		...
		while (var1.method4133()) {
			...
			} else if (var1.field2349 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount
					&& class128.worldSelectRightSprite != null) {
				++Login.worldSelectPage;
			}
		}
		...
		if (MouseHandler.MouseHandler_lastButton == 1
			...
			if (MouseHandler.MouseHandler_lastPressedX >= var2 && MouseHandler.MouseHandler_lastPressedX <= var2 + 14
			...
			if (MouseHandler.MouseHandler_lastPressedX >= var2 + 15
					&& MouseHandler.MouseHandler_lastPressedX <= var2 + 80
					&& MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) {
			...
			if (Login.worldSelectPage > 0 && class299.worldSelectLeftSprite != null
					...
					&& MouseHandler.MouseHandler_lastPressedX <= class299.worldSelectLeftSprite.subWidth
					&& MouseHandler.MouseHandler_lastPressedY >= WorldMapID.canvasHeight / 2 - 50
					&& MouseHandler.MouseHandler_lastPressedY <= WorldMapID.canvasHeight / 2 + 50) {
				--Login.worldSelectPage;
			}

			if (Login.worldSelectPage < Login.worldSelectPagesCount && class128.worldSelectRightSprite != null
					&& MouseHandler.MouseHandler_lastPressedX >= class448.canvasWidth
							- class128.worldSelectRightSprite.subWidth - 5
					&& MouseHandler.MouseHandler_lastPressedX <= class448.canvasWidth
					&& MouseHandler.MouseHandler_lastPressedY >= WorldMapID.canvasHeight / 2 - 50
					&& MouseHandler.MouseHandler_lastPressedY <= WorldMapID.canvasHeight / 2 + 50) {
				++Login.worldSelectPage;
