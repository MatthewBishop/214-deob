public class class166 extends class142 {
	...
	static class130[] method3387() {
		return new class130[] { class130.field1534, class130.field1529, class130.field1530, class130.field1531,
				class130.field1532, class130.field1533 };
	}
	...
	static final void method3380(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field579; ++var1) {
			...
			if ((var4 & 65536) != 0) {
				...
				var3.turnRightSequence = (var5 & 2) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.turnRightSequence;
				...
				var3.walkLeftSequence = (var5 & 16) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.walkLeftSequence;
				var3.walkRightSequence = (var5 & 32) != 0 ? var0.readUnsignedShort()
						: var3.definition.walkRightSequence;
			...
			if ((var4 & 4) != 0) {
				...
				} else if (var5 == -1 || var3.sequence == -1
						|| WorldMapLabelSize.SequenceDefinition_get(var5).field2278 >= WorldMapLabelSize
								.SequenceDefinition_get(var3.sequence).field2278) {
					var3.sequence = var5;
					var3.sequenceFrame = 0;
					var3.sequenceFrameCycle = 0;
					var3.sequenceDelay = var6;
