public class DynamicObject extends Renderable {
		...
		if (var7 != -1) {
			...
			if (var8 && this.sequenceDefinition.frameCount != -1) {
				if (!this.sequenceDefinition.isCachedModelIdSet()) {
					...
					this.cycleStart -= (int) (Math.random()
							* (double) this.sequenceDefinition.frameLengths[this.frame]);
				} else {
	...
	protected final Model getModel() {
		...
		if (var12 == null) {
			...
			return var12.getModelDynamic(this.type, this.orientation, var8, var10, var9, var11, this.sequenceDefinition,
					this.frame);
		}
	}
}
