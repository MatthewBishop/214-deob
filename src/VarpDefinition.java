...
public class VarpDefinition extends DualNode {
		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					int var55 = (var47[var12 - 1][var11] >> 2) + (var47[var12][var11 - 1] >> 2)
							+ (var47[var12 + 1][var11] >> 3) + (var47[var12][var11 + 1] >> 3)
							+ (var47[var12][var11] >> 1);
						...
						if (var17 >= 1 && var17 < 103
							...
							if (var23 > 0 || var24 > 0) {
								...
								if (var2 > 0) {
									...
									if (var24 > 0) {
										var37 = var24 - 1;
										var38 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
												.get((long) var37);
										FloorOverlayDefinition var48;
										if (var38 != null) {
											var48 = var38;
										} else {
											byte[] var39 = FloorOverlayDefinition.FloorOverlayDefinition_archive
													.takeFile(4, var37);
											...
											var38.postDecode();
											FloorOverlayDefinition.FloorOverlayDefinition_cached.put(var38,
													(long) var37);
											var48 = var38;
										}
								...
								if (var24 == 0) {
									var0.addTile(var2, var11, var17, 0, 0, -1, var25, var26, var27, var28,
											ItemContainer.method2230(var33, var29),
											ItemContainer.method2230(var33, var30),
											ItemContainer.method2230(var33, var31),
											ItemContainer.method2230(var33, var32), 0, 0, 0, 0, var35, 0);
								} else {
									var36 = Player.Tiles_shapes[var2][var11][var17] + 1;
									byte var63 = Tiles.field1018[var2][var11][var17];
									int var49 = var24 - 1;
									FloorOverlayDefinition var40 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
											.get((long) var49);
									if (var40 != null) {
										var38 = var40;
									} else {
										byte[] var41 = FloorOverlayDefinition.FloorOverlayDefinition_archive.takeFile(4,
												var49);
									...
									int var45;
									if (var50 >= 0) {
										var43 = Rasterizer3D.clips.Rasterizer3D_textureLoader
												.getAverageTextureRGB(var50);
										var42 = -1;
									...
									var44 = 0;
									if (var43 != -2) {
										var44 = Rasterizer3D.Rasterizer3D_colorPalette[AbstractSocket.method7958(var43,
												96)];
									}
									...
									var0.addTile(var2, var11, var17, var36, var63, var50, var25, var26, var27, var28,
											ItemContainer.method2230(var33, var29),
											ItemContainer.method2230(var33, var30),
											ItemContainer.method2230(var33, var31),
											ItemContainer.method2230(var33, var32),
											AbstractSocket.method7958(var42, var29),
											AbstractSocket.method7958(var42, var30),
											AbstractSocket.method7958(var42, var31),
											AbstractSocket.method7958(var42, var32), var35, var44);
								}
							}
						}
					}
				...
				for (int var59 = 0; var59 <= 104; ++var59) {
					for (int var60 = 0; var60 <= 104; ++var60) {
						...
						if ((Tiles.field1020[var58][var60][var59] & var2) != 0) {
							...
							for (var12 = var58; var9 > 0
									&& (Tiles.field1020[var58][var60][var9 - 1] & var2) != 0; --var9) {
							}
							...
							if (var13 >= 8) {
								...
								Scene.Scene_addOccluder(var5, 1, var60 * 128, var60 * 128, var9 * 128,
						...
						if ((Tiles.field1020[var58][var60][var59] & var3) != 0) {
							...
							for (var12 = var58; var9 > 0
									&& (Tiles.field1020[var58][var9 - 1][var59] & var3) != 0; --var9) {
							}
							...
							if (var13 >= 8) {
								...
								Scene.Scene_addOccluder(var5, 2, var9 * 128, var10 * 128 + 128, var59 * 128,
										var59 * 128, var15, var16);
						...
						if ((Tiles.field1020[var58][var60][var59] & var4) != 0) {
							...
							for (var12 = var59; var11 > 0
									&& (Tiles.field1020[var58][var60][var11 - 1] & var4) != 0; --var11) {
							}
	...
	static int method3586(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_GETTARGETMASK) {
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = LoginScreenAnimation
					.Widget_unpackTargetMask(StudioGame.getWidgetFlags(var3));
			return 1;
