...
public class class60 {
	...
	static int method1133(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.OC_NAME) {
			...
			Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = class300
			...
			if (var0 == ScriptOpcodes.OC_OP) {
				...
				if (var6 >= 1 && var6 <= 5 && var5.inventoryActions[var6 - 1] != null) {
					Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
							- 1] = var5.inventoryActions[var6 - 1];
				} else {
					Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = "";
				}
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
						- 1] = class300.ItemDefinition_get(var3).isStackable == 1 ? 1 : 0;
				return 1;
			} else {
				...
				if (var0 == ScriptOpcodes.OC_CERT) {
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = class300.ItemDefinition_get(var3).isMembersOnly ? 1 : 0;
					return 1;
					...
					if (class18.foundItemIds != null && class13.foundItemIndex < class105.foundItemIdCount) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class18.foundItemIds[++class13.foundItemIndex - 1] & '\uffff';
					} else {
