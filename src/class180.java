		...
		if (var0 == ScriptOpcodes.CC_SETSCROLLPOS) {
			...
			if (var0 == ScriptOpcodes.CC_SETTEXTFONT) {
				...
				if (var3.type == 12) {
					var10 = var3.method6380();
					if (var10 != null) {
						var10.method6066(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
				...
				if (var0 == ScriptOpcodes.CC_SETLINEDIRECTION) {
					...
					var3.method6386(Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize],
							class47.urlRequester, class27.method406());
					return 1;
				} else if (var0 == 1131) {
					Interpreter.Interpreter_intStackSize -= 2;
					var3.method6367(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
							Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
					return 1;
				} else if (var0 == 1132) {
					var3.method6368(Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize],
					...
					if (var0 == 1133) {
						...
						var10 = var3.method6380();
						if (var10 != null && var10
								.method6167(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							Messages.invalidateWidget(var3);
						}
						...
						var10 = var3.method6380();
						if (var10 != null && var10
								.method6110(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							Messages.invalidateWidget(var3);
						}
						...
						var10 = var3.method6380();
						if (var10 != null && var10
								.method6064(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							Messages.invalidateWidget(var3);
						}
						...
						if (var0 == 1140) {
							...
							Interpreter.Interpreter_intStackSize -= 2;
							var10 = var3.method6380();
							if (var10 != null && var10.method6080(
									Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
									Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1])) {
								Messages.invalidateWidget(var3);
							}
