public class FaceNormal {
	...
	static int method4719(int var0, int var1) {
		FloorOverlayDefinition var3 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
				.get((long) var0);
		...
		if (var2 == null) {
			...
			if (var2.secondaryRgb >= 0) {
				...
				int var10;
				if (var2.texture >= 0) {
					var10 = SecureRandomCallable.method2214(
							Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var2.texture), 96);
