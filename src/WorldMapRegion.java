...
public class WorldMapRegion {
	...
	void getIconsForTiles(int var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
		for (int var6 = var1; var6 < var3 + var1; ++var6) {
			label50: for (int var7 = var2; var7 < var2 + var4; ++var7) {
	...
	void getIcon(ObjectComposition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
		...
		if (this.worldMapData_0 != null) {
			var7 = new Coord(this.worldMapData_0.minPlane + var2, var3 + this.worldMapData_0.regionXLow * 64,
					this.worldMapData_0.regionYLow * 4096 + var4);
		} else {
			WorldMapData_1 var8 = (WorldMapData_1) var5;
			var7 = new Coord(var2 + var8.minPlane, var3 + var8.regionXLow * 64 + var8.getChunkXLow() * 8,
					var8.regionYLow * 4096 + var4 + var8.getChunkYLow() * 8);
		}
	...
	void addAllToIconList(List var1) {
		...
		while (var2.hasNext()) {
			...
			if (class147.WorldMapElement_get(var3.element).field1912 && var3.coord2.x >> 6 == this.regionX
					&& var3.coord2.y >> 6 == this.regionY) {
				WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element,
						this.method5202(var3.element));
		...
		if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) {
			...
			if (var6 == null) {
				...
				if (var9) {
					...
					WorldMapRegion_cachedSprites.put(var14, class388.method7211(var15, var16, var17),
							var14.pixels.length * 4);
					this.method5180();
				}
			}
		}
	...
	void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
		...
		if (var7 > -1 && var3.field2988[0][var1][var2] == 0) {
			...
			if (var7 == -1) {
				...
				var4.method5560(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8,
						this.pixelsPerTile, this.pixelsPerTile, var3.field2988[0][var1][var2],
						var3.field2985[0][var1][var2]);
			}
		}
	}
		...
		for (int var5 = 1; var5 < var3.planes; ++var5) {
			...
			if (var6 > -1) {
				...
				if (var3.field2988[var5][var1][var2] == 0) {
					...
					var4.method5560(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7,
							this.pixelsPerTile, this.pixelsPerTile, var3.field2988[var5][var1][var2],
							var3.field2985[var5][var1][var2]);
				}
			}
		}
					...
					if (Client.method1203(var9.decoration) || FloorOverlayDefinition.method4035(var9.decoration)) {
						...
						if (var10.mapSceneId != -1) {
							if (var10.mapSceneId != 46 && var10.mapSceneId != 52) {
								var4[var10.mapSceneId].method9367(this.pixelsPerTile * var1,
		...
		if (var6 != null) {
			if (var6.size.method5061(var5)) {
				...
				var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height,
						-16777216 | var2.field1909, 0, 1, 0, var7.ascent / 2);
			}
		}
	}
	...
	void method5206(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 2) {
			Rasterizer2D.Rasterizer2D_drawVerticalLine(this.pixelsPerTile + this.pixelsPerTile * var1 - 1,
