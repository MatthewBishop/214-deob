public class class152 extends class142 {
	...
	static final void method3194(boolean var0) {
		if (var0) {
			...
			Client.field677 = class10.clientPreferences.method2484(Login.Login_username) ? class138.field1607
					: class138.field1608;
		}
		...
		for (var9 = 0; var9 < Client.overheadTextCount; ++var9) {
			...
			while (var14) {
				...
				for (int var20 = 0; var20 < var9; ++var20) {
					if (var11 + 2 > Client.overheadTextYs[var20] - Client.overheadTextAscents[var20]
							&& var11 - var13 < Client.overheadTextYs[var20] + 2
							&& var10 - var12 < Client.overheadTextXs[var20] + Client.overheadTextXOffsets[var20]
							&& var10 + var12 > Client.overheadTextXs[var20] - Client.overheadTextXOffsets[var20]
							&& Client.overheadTextYs[var20] - Client.overheadTextAscents[var20] < var11) {
			...
			if (Client.chatEffects == 0) {
				...
				if (Client.overheadTextEffects[var9] == 0) {
					class166.fontBold12.method7416(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
							var16, 0, Client.field614[var9]);
				}

				if (Client.overheadTextEffects[var9] == 1) {
					class166.fontBold12.method7433(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
							var16, 0, Client.viewportDrawCount, Client.field614[var9]);
				}

				if (Client.overheadTextEffects[var9] == 2) {
					class166.fontBold12.method7434(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
							var16, 0, Client.viewportDrawCount, Client.field614[var9]);
				}

				if (Client.overheadTextEffects[var9] == 3) {
					class166.fontBold12.method7488(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
							var16, 0, Client.viewportDrawCount, 150 - Client.overheadTextCyclesRemaining[var9],
							Client.field614[var9]);
				}

				if (Client.overheadTextEffects[var9] == 4) {
					var17 = (150 - Client.overheadTextCyclesRemaining[var9])
							* (class166.fontBold12.stringWidth(var15) + 100) / 150;
					Rasterizer2D.Rasterizer2D_expandClip(var0 + Client.viewportTempX - 50, var1,
							var0 + Client.viewportTempX + 50, var3 + var1);
					class166.fontBold12.method7435(var15, var0 + Client.viewportTempX + 50 - var17,
							Client.viewportTempY + var1, var16, 0, Client.field614[var9]);
				...
				if (Client.overheadTextEffects[var9] == 5) {
					...
					Rasterizer2D.Rasterizer2D_expandClip(var0,
							Client.viewportTempY + var1 - class166.fontBold12.ascent - 1, var0 + var2,
							Client.viewportTempY + var1 + 5);
					class166.fontBold12.method7416(var15, var0 + Client.viewportTempX,
							var18 + Client.viewportTempY + var1, var16, 0, Client.field614[var9]);
					Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
				}
			} else {
				class166.fontBold12.drawCentered(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
						16776960, 0);
			}
		}
