public class class130 implements MouseWheel {
	...
	static float method3002(class129 var0, float var1) {
		if (var0 != null && var0.method2981() != 0) {
			if (var1 < (float) var0.field1510[0].field1457) {
				return var0.field1506 == class127.field1494 ? var0.field1510[0].field1455
						: class72.method2050(var0, var1, true);
			} else if (var1 > (float) var0.field1510[var0.method2981() - 1].field1457) {
				return var0.field1507 == class127.field1494 ? var0.field1510[var0.method2981() - 1].field1455
						: class72.method2050(var0, var1, false);
				...
				if (var2 == null) {
								...
								if (var0 != null) {
									...
									if (0.0 != (double) var17) {
										...
										if (var22 != var20[1]) {
											...
											if ((double) var22 != 1.0) {
												var16 = (float) ((double) var12 - (double) (var12 - var11)
														* (1.0 - (double) var20[1]) / (1.0 - (double) var22));
											}
										}
					...
					if (var3) {
						...
						return var1 != (float) var2.field1457 && var2.field1460 != null ? var2.field1460.field1455
								: var2.field1455;
						...
						if (var0 == null) {
							...
							if (var0.field1508) {
								...
								int var29 = class72.method2044(class125.field1465, 3, 0.0F, true, 1.0F, true,
										class125.field1462);
								if (var29 == 1) {
							...
							var5 = var0.field1509
									+ var7 * (var0.field1512 + var7 * (var7 * var0.field1527 + var0.field1518));
						}
						...
						if (var0 == null) {
							...
							var5 = var6 * ((var0.field1504 + var6 * var0.field1522) * var6 + var0.field1514)
									+ var0.field1515;
						}
	...
	static int method3007(int var0, Script var1, boolean var2) {
		if (var0 == 7108) {
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class327.method6088() ? 1
					: 0;
			return 1;
		} else {
			return 2;
