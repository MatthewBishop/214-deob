...
public class Players {
	...
	static int method2699(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			SpotAnimationDefinition.privateChatMode = class404
					.method7633(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			...
			PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.CHAT_SETFILTER,
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = ObjectComposition.getPacketBufferNode(ClientPacket.CHAT_SENDABUSEREPORT,
						Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var5 != null) {
						...
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
								- 1] = var5.sender != null ? var5.sender : "";
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
								- 1] = var5.prefix != null ? var5.prefix : "";
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
								- 1] = var5.text != null ? var5.text : "";
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var5
								.isFromFriend() ? 1 : (var5.isFromIgnored() ? 2 : 0);
					} else {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var4 != null) {
							...
							Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
									- 1] = var4.sender != null ? var4.sender : "";
							Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
									- 1] = var4.prefix != null ? var4.prefix : "";
							Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
									- 1] = var4.text != null ? var4.text : "";
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var4
									.isFromFriend() ? 1 : (var4.isFromIgnored() ? 2 : 0);
						} else {
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
							Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = "";
						...
						if (SpotAnimationDefinition.privateChatMode == null) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = SpotAnimationDefinition.privateChatMode.field5156;
						}
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var8 = Interpreter.Interpreter_stringStack[class149.Interpreter_stringStackSize];
							String var11 = Interpreter.Interpreter_stringStack[class149.Interpreter_stringStackSize
									+ 1];
							var12 = ObjectComposition.getPacketBufferNode(ClientPacket.CHAT_SENDPRIVATE,
									Client.packetWriter.isaacCipher);
							...
							if (var0 == ScriptOpcodes.CHAT_GETFILTER_TRADE) {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
										- 1] = Client.tradeChatMode;
								return 1;
							} else if (var0 == ScriptOpcodes.CHAT_GETHISTORYLENGTH) {
								var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
										- 1] = UserComparator3.Messages_getHistorySize(var3);
								return 1;
							} else if (var0 == ScriptOpcodes.CHAT_GETNEXTUID) {
								var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class104
										.Messages_getLastChatID(var3);
								return 1;
							} else if (var0 == ScriptOpcodes.CHAT_GETPREVUID) {
								var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
										- 1] = LoginPacket.method5680(var3);
								return 1;
								...
								Client.field736 = Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize]
										.toLowerCase().trim();
								return 1;
