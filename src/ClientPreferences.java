...
public class ClientPreferences {
	...
	static void method2433(Font var0, Font var1) {
		...
		if (class299.worldSelectLeftSprite == null) {
			class299.worldSelectLeftSprite = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(class180.archive8,
					"leftarrow", "");
		}

		if (class128.worldSelectRightSprite == null) {
			class128.worldSelectRightSprite = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(class180.archive8,
					"rightarrow", "");
		}
		...
		if (class16.worldSelectBackSprites != null) {
			...
			if (class299.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
				class299.worldSelectLeftSprite.drawAt(8,
						WorldMapID.canvasHeight / 2 - class299.worldSelectLeftSprite.subHeight / 2);
			}

			if (class128.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
				class128.worldSelectRightSprite.drawAt(
						class448.canvasWidth - class128.worldSelectRightSprite.subWidth - 8,
						WorldMapID.canvasHeight / 2 - class128.worldSelectRightSprite.subHeight / 2);
			}
			...
			for (var16 = var15 * var5; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
				...
				if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var11
						&& MouseHandler.MouseHandler_x < var23 + var12 && MouseHandler.MouseHandler_y < var24 + var11
						&& var18) {
				...
				if (class134.worldSelectFlagSprites != null) {
					class134.worldSelectFlagSprites[(var17.isMembersOnly() ? 8 : 0) + var17.location].drawAt(var12 + 29,
							var11);
				}
			...
			if (var14) {
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(MouseHandler.MouseHandler_x - var16 / 2, var25, var16, var22,
						16777120);
				Rasterizer2D.Rasterizer2D_drawRectangle(MouseHandler.MouseHandler_x - var16 / 2, var25, var16, var22,
						0);
				var1.drawCentered(World.World_worlds[Login.hoveredWorldIndex].activity, MouseHandler.MouseHandler_x,
