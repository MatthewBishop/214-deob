public final class SpritePixels extends Rasterizer2D {
	...
	public SpritePixels copyNormalized() {
		...
		for (int var2 = 0; var2 < this.subHeight; ++var2) {
			for (int var3 = 0; var3 < this.subWidth; ++var3) {
				var1.pixels[var3 + (var2 + this.yOffset) * this.width + this.xOffset] = this.pixels[var3
						+ var2 * this.subWidth];
			}
		}
	...
	public void normalize() {
		if (this.subWidth != this.width || this.subHeight != this.height) {
			...
			for (int var2 = 0; var2 < this.subHeight; ++var2) {
				for (int var3 = 0; var3 < this.subWidth; ++var3) {
					var1[var3 + (var2 + this.yOffset) * this.width + this.xOffset] = this.pixels[var3
							+ var2 * this.subWidth];
				}
			}
	...
	public void drawScaledAt(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) {
			...
			Sprite_drawScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4,
					var11, var12, var5);
		}
	}
	...
	public void drawTransOverlayAt(int var1, int var2, int var3, int var4) {
		if (var3 == 256) {
			...
			if (var8 > 0 && var7 > 0) {
				Sprite_drawTransOverlay(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9,
						var10, var3, var4);
			}
		}
	}
	...
	public void drawTransAt(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) {
			Sprite_drawTransparent(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9,
					var3);
		}
	}
	...
	public void drawTransScaledAt(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			Sprite_drawTransScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3,
	...
	public void method9417(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				method9408(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8,
						var9);
			} else {
				method9406(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8,
						var9, var3);
			}
	...
	public void method9398(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var5 == 256) {
				method9423(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14,
						var15, var3, var12, var13, var6);
			} else {
				method9409(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14,
						var15, var3, var12, var13, var6, var5);
			}
	...
	public void drawRotatedMaskedCenteredAround(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
		...
		try {
			...
			for (var2 = 0; var2 < var4; ++var2) {
				...
				for (var1 = -var10[var2]; var1 < 0; ++var1) {
					Rasterizer2D.Rasterizer2D_pixels[var19++] = this.pixels[this.subWidth * (var21 >> 16)
							+ (var20 >> 16)];
					var20 += var14;
					var21 -= var13;
				}
					...
					if (var27 == 0) {
						if (var26 == 0) {
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
								...
								var36 = var31;
								var37 = var20;
								if (var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0
										&& var31 - (this.subHeight << 12) < 0) {
									for (; var37 < 0; ++var37) {
	...
	static void Sprite_drawTransBg(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	static void Sprite_drawScaled(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
	...
	static void Sprite_drawTransOverlay(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
	...
	static void Sprite_drawTransparent(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
		...
		for (int var11 = -var6; var11 < 0; ++var11) {
			for (int var12 = -var5; var12 < 0; ++var12) {
				...
				if (var2 != 0) {
					int var13 = var0[var4];
					var0[var4++] = ((var13 & 16711935) * var10 + var9 * (var2 & 16711935) & -16711936)
	...
	static void Sprite_drawTransScaled(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
		...
		for (int var15 = -var8; var15 < 0; ++var15) {
			...
			for (int var17 = -var7; var17 < 0; ++var17) {
				...
				if (var2 != 0) {
					int var18 = var0[var5];
					var0[var5++] = ((var2 & '\uff00') * var12 + var13 * (var18 & '\uff00') & 16711680)
							+ ((var18 & 16711935) * var13 + var12 * (var2 & 16711935) & -16711936) >> 8;
				} else {
					++var5;
				}
	...
	static void method9408(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8,
	...
	static void method9406(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8,
	...
	static void method9423(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
	...
	static void method9409(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8,
