public class MusicPatchPcmStream extends PcmStream {
		...
		if ((this.superStream.field3421[var1.field3490] & 4) != 0 && var1.field3489 < 0) {
			...
			while (true) {
				...
				if (this.superStream.field3424[var1.field3490] == 0) {
					var1.stream = RawPcmStream.method949(var1.rawSound, var10.method865(), var10.method856(),
							var10.method857());
				} else {
	...
	void method5933(MusicPatchNode var1, int var2) {
		if ((this.superStream.field3421[var1.field3490] & 4) != 0 && var1.field3489 < 0) {
			...
			if (var4 <= var2) {
				if (this.superStream.field3424[var1.field3490] == 0) {
					var1.stream = RawPcmStream.method949(var1.rawSound, var1.stream.method865(),
							var1.stream.method856(), var1.stream.method857());
				} else {
					var1.stream = RawPcmStream.method949(var1.rawSound, var1.stream.method865(), 0,
	...
	protected void fill(int[] var1, int var2, int var3) {
		...
		for (MusicPatchNode var6 = (MusicPatchNode) this.queue.last(); var6 != null; var6 = (MusicPatchNode) this.queue
				.previous()) {
	...
	protected void skip(int var1) {
		...
		for (MusicPatchNode var3 = (MusicPatchNode) this.queue.last(); var3 != null; var3 = (MusicPatchNode) this.queue
				.previous()) {
		...
		if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field4483) {
			...
			if (JagexCache.ByteArrayPool_arrays != null) {
				for (int var1 = 0; var1 < class152.ByteArrayPool_alternativeSizes.length; ++var1) {
					if (var0.length == class152.ByteArrayPool_alternativeSizes[var1]
							&& PendingSpawn.ByteArrayPool_altSizeArrayCounts[var1] < JagexCache.ByteArrayPool_arrays[var1].length) {
				...
				label72: {
					if (var3.equipment[0] >= 512) {
						...
						if (var3.equipment[0] < 512) {
							...
							var8 = var6.maleModel1 != class208.field2312.field2315
									&& var6.maleModel2 != class208.field2312.field2315;
						}
