public class class464 extends class467 {
	...
	public class464(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
			int var10) {
		super(var9, var10);
		this.field4799 = var3;
		this.field4797 = var6;
		if ((var5 - var8) * (var7 - var1) == (var4 - var7) * (var8 - var2)) {
			...
			this.field4800 = Math.sqrt(
					Math.pow(this.field4796 - (double) var1, 2.0) + Math.pow(this.field4798 - (double) var2, 2.0));
			...
			boolean var25 = this.field4801 <= var23 && var23 <= this.field4802
					|| this.field4802 <= var23 && var23 <= this.field4801;
			if (!var25) {
	...
	static final int method8328(int var0, int var1) {
		int var2 = UserComparator4.method2848(var0 - 1, var1 - 1) + UserComparator4.method2848(var0 + 1, var1 - 1)
				+ UserComparator4.method2848(var0 - 1, var1 + 1) + UserComparator4.method2848(var0 + 1, var1 + 1);
		int var3 = UserComparator4.method2848(var0 - 1, var1) + UserComparator4.method2848(1 + var0, var1)
				+ UserComparator4.method2848(var0, var1 - 1) + UserComparator4.method2848(var0, 1 + var1);
