public class LoginScreenAnimation {
	...
	final void method2404(int var1) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			var6 = this.field1245[var2 + var3]
					- this.field1250[var2 + this.field1249 & this.field1250.length - 1] * var1 / 6;
			if (var6 < 0) {
				var6 = 0;
			}
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1243[var7] = (int) (Math.sin((double) this.field1238 / 14.0) * 16.0
					+ Math.sin((double) this.field1238 / 15.0) * 14.0
					+ Math.sin((double) this.field1238 / 16.0) * 12.0);
			++this.field1238;
		}
	...
	final int method2416(int var1, int var2, int var3) {
		int var4 = 256 - var3;
		return (var3 * (var2 & '\uff00') + var4 * (var1 & '\uff00') & 16711680)
				+ (var3 * (var2 & 16711935) + var4 * (var1 & 16711935) & -16711936) >> 8;
	}
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart
					...
					WorldMapSectionType.rasterProvider.pixels[var8++] = -16777216
							| ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936)
									+ (var13 * (var14 & '\uff00') + var12 * (var10 & '\uff00') & 16711680) >> 8;
				} else {
					++var8;
				}
			}
		...
		for (var2 = 0; var2 < 20; ++var2) {
			for (var3 = 1; var3 < 255; ++var3) {
				for (var4 = 1; var4 < 127; ++var4) {
					var5 = var4 + (var3 << 7);
					this.field1247[var5] = (this.field1250[var5 + 1] + this.field1250[var5 + 128]
							+ this.field1250[var5 - 128] + this.field1250[var5 - 1]) / 4;
				}
			}
	...
	static class137[] method2429() {
		return new class137[] { class137.field1601, class137.field1593, class137.field1594, class137.field1595,
				class137.field1592, class137.field1597, class137.field1598, class137.field1599, class137.field1600 };
	}
