...
public class class367 {
	...
	public class367() {
		...
		for (var3 = 12; var1 < 16; var2 -= var3) {
			var4 = class60.method1135((double) ((float) var2 / 360.0F), 0.9998999834060669,
					(double) ((float) var1 * 0.425F / 16.0F + 0.075F));
			field4327[var1] = var4;
			++var1;
		}
		...
		for (var3 = var2 / 6; var1 < field4327.length; var2 -= var3) {
			...
			for (int var5 = class60.method1135((double) ((float) var2 / 360.0F), 0.9998999834060669, 0.5); var1 < var4
					&& var1 < field4327.length; ++var1) {
				field4327[var1] = var5;
			}
		}
