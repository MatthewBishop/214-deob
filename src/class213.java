	...
	static final void method4211(class294 var0) {
		...
		if (class294.field3207 == var0) {
			...
			if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
				var10 = var6 + 1;
				if (Projectile.localPlayer.pathX[0] >= var3 - var10 && Projectile.localPlayer.pathX[0] <= var3 + var10
						&& Projectile.localPlayer.pathY[0] >= var4 - var10
						&& Projectile.localPlayer.pathY[0] <= var10 + var4
						&& class10.clientPreferences.method2450() != 0 && var7 > 0 && Client.soundEffectCount < 50) {
		...
		if (class294.field3201 == var0) {
			...
			if (var17 != null) {
				...
				if (var29 != null) {
					BoundaryObject.method5026(Clock.Client_plane, var14, var15, var10, -1, 0, 0, 31, var2 + 1,
							var11 + 1);
		...
		if (class294.field3205 == var0) {
			...
			if (var4 >= 0 && var5 >= 0 && var4 < 103 && var5 < 103) {
				if (var9 == 0) {
					...
					if (var35 != null) {
						...
						if (var7 == 2) {
							var35.renderable1 = new DynamicObject(var11, 2, var8 + 4, Clock.Client_plane, var4, var5,
									var2, false, var35.renderable1);
							var35.renderable2 = new DynamicObject(var11, 2, var8 + 1 & 3, Clock.Client_plane, var4,
									var5, var2, false, var35.renderable2);
						} else {
							var35.renderable1 = new DynamicObject(var11, var7, var8, Clock.Client_plane, var4, var5,
									var2, false, var35.renderable1);
						}
				...
				if (var9 == 1) {
					...
					if (var42 != null) {
						...
						if (var7 != 4 && var7 != 5) {
							if (var7 == 6) {
								var42.renderable1 = new DynamicObject(var11, 4, var8 + 4, Clock.Client_plane, var4,
										var5, var2, false, var42.renderable1);
							} else if (var7 == 7) {
								var42.renderable1 = new DynamicObject(var11, 4, (var8 + 2 & 3) + 4, Clock.Client_plane,
										var4, var5, var2, false, var42.renderable1);
							} else if (var7 == 8) {
								var42.renderable1 = new DynamicObject(var11, 4, var8 + 4, Clock.Client_plane, var4,
										var5, var2, false, var42.renderable1);
								var42.renderable2 = new DynamicObject(var11, 4, (var8 + 2 & 3) + 4, Clock.Client_plane,
										var4, var5, var2, false, var42.renderable2);
							}
						} else {
							var42.renderable1 = new DynamicObject(var11, 4, var8, Clock.Client_plane, var4, var5, var2,
									false, var42.renderable1);
						}
				...
				if (var9 == 2) {
					...
					if (var43 != null) {
						var43.renderable = new DynamicObject(class215.Entity_unpackID(var43.tag), var7, var8,
								Clock.Client_plane, var4, var5, var2, false, var43.renderable);
						return;
					}
				}
				...
				if (var9 == 3) {
					...
					if (var44 != null) {
						var44.renderable = new DynamicObject(class215.Entity_unpackID(var44.tag), 22, var8,
								Clock.Client_plane, var4, var5, var2, false, var44.renderable);
						return;
					}
				}
			...
			if (class294.field3206 == var0) {
				...
				var2 = var37 + var11;
				var3 = var36 + var12;
				if (var11 >= 0 && var12 >= 0 && var11 < 104 && var12 < 104 && var2 >= 0 && var3 >= 0 && var2 < 104
						&& var3 < 104 && var6 != 65535) {
					var11 = var11 * 128 + 64;
					var12 = var12 * 128 + 64;
					var2 = var2 * 128 + 64;
					var3 = var3 * 128 + 64;
					Projectile var33 = new Projectile(var6, Clock.Client_plane, var11, var12,
							Renderable.getTileHeight(var11, var12, Clock.Client_plane) - var5, var13 + Client.cycle,
							var8 + Client.cycle, var14, var4, var9, var7);
					var33.setDestination(var2, var3, Renderable.getTileHeight(var2, var3, Clock.Client_plane) - var7,
							var13 + Client.cycle);
				...
				if (class294.field3200 == var0) {
					...
					if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
						var3 = var3 * 128 + 64;
						var4 = var4 * 128 + 64;
						GraphicsObject var41 = new GraphicsObject(var7, Clock.Client_plane, var3, var4,
								Renderable.getTileHeight(var3, var4, Clock.Client_plane) - var6, var5, Client.cycle);
				...
				if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
					...
					if (var31 != null) {
						for (TileItem var32 = (TileItem) var31.last(); var32 != null; var32 = (TileItem) var31
								.previous()) {
	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !UserComparator9.isComponentHidden(var3))) {
				int var5;
				if (var3.type == 0) {
					if (!var3.isIf3 && UserComparator9.isComponentHidden(var3)
							&& var3 != ClanChannel.mousedOverWidgetIf1) {
						continue;
					}
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.isCachedModelIdSet()) {
								for (var3.modelFrameCycle += Client.graphicsCycle; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; Messages
										.invalidateWidget(var3)) {
