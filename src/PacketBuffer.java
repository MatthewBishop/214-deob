public class PacketBuffer extends Buffer {
	...
	static final int[] field5013 = new int[] { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383,
	...
	public int readSmartByteShortIsaac() {
		...
		return var1 < 128 ? var1
				: (var1 - 128 << 8) + (super.array[++super.offset - 1] - this.isaacCipher.nextInt() & 255);
	}
