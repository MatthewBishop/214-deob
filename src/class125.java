...
public class class125 {
	...
	static void runScriptLogic(ScriptEvent var0, Script var1, int var2, int var3) {
		...
		label933: {
			label934: {
				try {
					...
					try {
						...
						label920: while (true) {
							...
							if (var8 >= 100) {
								...
								Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
										- 1] = var1.stringOperands[var5];
							} else if (var8 == 6) {
								var5 += var7[var5];
							} else if (var8 == 7) {
								Interpreter.Interpreter_intStackSize -= 2;
								if (Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] != Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
										+ 1]) {
									var5 += var7[var5];
								}
							} else if (var8 == 8) {
								...
								var13 = var7[var5];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class343
										.getVarbit(var13);
							} else if (var8 == 27) {
								var13 = var7[var5];
								Buffer.method9158(var13,
										Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
							} else if (var8 == 31) {
								Interpreter.Interpreter_intStackSize -= 2;
								if (Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
								...
								var20 = JagexCache.method3497(Interpreter.Interpreter_stringStack,
										class149.Interpreter_stringStackSize, var13);
								...
								if (var8 != 40) {
									if (var8 == 42) {
										Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
												- 1] = MouseHandler.varcs.getInt(var7[var5]);
									} else if (var8 == 43) {
										MouseHandler.varcs.setInt(var7[var5],
												Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
									} else if (var8 == 44) {
										var13 = var7[var5] >> 16;
										var14 = var7[var5] & '\uffff';
										...
										Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
												- 1] = Interpreter.Interpreter_arrays[var13][var14];
									} else if (var8 == 46) {
										var13 = var7[var5];
										Interpreter.Interpreter_intStackSize -= 2;
										var14 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
										...
										Interpreter.Interpreter_arrays[var13][var14] = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
												+ 1];
									} else {
										String var21;
										if (var8 == 47) {
											...
											MouseHandler.varcs.setStringOld(var7[var5],
													Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize]);
										} else if (var8 == 49) {
											...
											MouseHandler.varcs.setString(var7[var5],
													Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize]);
										} else if (var8 == 60) {
											IterableNodeHashTable var36 = var1.switches[var7[var5]];
											IntegerNode var35 = (IntegerNode) var36.get(
													(long) Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
											if (var35 != null) {
												var5 += var35.integer;
											}
										} else {
					...
					if (var29) {
						while (Interpreter.field873.size() > 0) {
							...
							InvDefinition.widgetDefaultMenuAction(var19.method2628(), var19.method2629(),
									var19.method2639(), var19.method2631(), "");
						}
						...
						if (!var9 && var3 > 0 && var10 >= var3) {
							class260.RunException_sendStackTrace("Warning: Script " + var1.field992
									+ " finished at op count " + var10 + " of max " + var2, (Throwable) null);
						}
				...
				while (Interpreter.field873.size() > 0) {
					...
					InvDefinition.widgetDefaultMenuAction(var32.method2628(), var32.method2629(), var32.method2639(),
							var32.method2631(), "");
				}
				...
				if (!var9 && var3 > 0 && var10 >= var3) {
					class260.RunException_sendStackTrace(
							"Warning: Script " + var1.field992 + " finished at op count " + var10 + " of max " + var2,
							(Throwable) null);
				}
			...
			while (Interpreter.field873.size() > 0) {
				...
				InvDefinition.widgetDefaultMenuAction(var39.method2628(), var39.method2629(), var39.method2639(),
						var39.method2631(), "");
			}
		...
		while (Interpreter.field873.size() > 0) {
			...
			InvDefinition.widgetDefaultMenuAction(var25.method2628(), var25.method2629(), var25.method2639(),
					var25.method2631(), "");
		}
