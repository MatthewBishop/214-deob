...
public class WorldMapSection2 implements WorldMapSection {
	...
	public boolean containsPosition(int var1, int var2) {
		return var1 >> 6 >= this.field2882 && var1 >> 6 <= this.field2884 && var2 >> 6 >= this.field2883
				&& var2 >> 6 <= this.field2880;
	}
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[] { this.field2882 * 64 - this.regionStartX * 64 + var2,
					var3 + (this.field2883 * 64 - this.regionStartY * 64) };
			return var4;
		}
	}
		...
		try {
			if (class304.musicPlayerStatus == 2) {
				if (class237.musicTrack == null) {
					class237.musicTrack = MusicTrack.readTrack(UserComparator9.musicTrackArchive,
							VarbitComposition.musicTrackGroupId, class304.musicTrackFileId);
					if (class237.musicTrack == null) {
						return false;
					}
				}
				...
				if (class304.midiPcmStream.method5806(class237.musicTrack, class304.field3396, class304.soundCache)) {
					...
					if (var0 != null) {
						...
						if (class304.field3393 == null) {
							...
							class304.field3393 = new ThreadPoolExecutor(0, var2, 0L, TimeUnit.MILLISECONDS,
									new LinkedBlockingQueue(), new class305());
						}
