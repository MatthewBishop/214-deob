...
public class class136 extends DualNode {
	...
	static int method3075(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ADD) {
			...
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
					- 1] = (int) (Math.random() * (double) var9);
			return 1;
		} else if (var0 == ScriptOpcodes.RANDOMINC) {
			var9 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
					- 1] = (int) (Math.random() * (double) (var9 + 1));
			return 1;
		} else {
			int var5;
			int var6;
			...
			if (var0 == ScriptOpcodes.INTERPOLATE) {
				...
				var9 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = (var9 & 1 << var4) != 0
						? 1
						: 0;
				return 1;
				...
				if (var9 == 0) {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = (int) Math
							.pow((double) var9, (double) var4);
				}
				...
				if (var9 == 0) {
					...
					case 4:
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = (int) Math
								.sqrt(Math.sqrt((double) var9));
						break;
					default:
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = (int) Math
								.pow((double) var9, 1.0 / (double) var4);
					}
				...
				var9 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var9 < var4 ? var9
						: var4;
				return 1;
			} else if (var0 == 4017) {
				Interpreter.Interpreter_intStackSize -= 2;
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
						- 1] = (int) (var10 * var14 / var12);
				return 1;
			} else if (var0 == ScriptOpcodes.BITCOUNT) {
				var9 = FloorOverlayDefinition
						.method4023(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var9;
				return 1;
				...
				var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = MouseHandler
						.method642(var9, var4, var5);
				return 1;
				...
				var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = PlayerComposition
						.method6052(var9, var4, var5);
				return 1;
				...
				var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
				var6 = 31 - var5;
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var9 << var6 >>> var6
						+ var4;
				return 1;
			} else if (var0 == 4030) {
				...
				Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1] = MouseHandler
						.method655(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4033) {
				Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
						- 1] = GrandExchangeOfferWorldComparator
								.method6833(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4034) {
				Interpreter.Interpreter_intStackSize -= 2;
				var9 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
				...
				Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1] = Math
						.abs(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4036) {
		...
		if (Client.titleLoadingStage == 0) {
			...
			if (Client.titleLoadingStage == 45) {
				...
				if (Client.titleLoadingStage == 50) {
					FontName[] var28 = new FontName[] { FontName.FontName_plain12, FontName.FontName_bold12,
							FontName.FontName_verdana13, FontName.FontName_verdana11, FontName.FontName_verdana15,
							FontName.FontName_plain11 };
					var19 = var28.length;
					Fonts var30 = class490.WorldMapElement_fonts;
					FontName[] var38 = new FontName[] { FontName.FontName_plain12, FontName.FontName_bold12,
							FontName.FontName_verdana13, FontName.FontName_verdana11, FontName.FontName_verdana15,
							FontName.FontName_plain11 };
					...
					if (Client.titleLoadingStage == 60) {
						...
						if (!MouseRecorder.archive2.isFullyLoaded()) {
							...
							class435.ItemDefinition_fileCount = ItemComposition.ItemDefinition_archive
									.getGroupFileCount(10);
							...
							GraphicsObject.HitSplatDefinition_cachedSprites = new class485(GameBuild.field3841, 54,
									TriBool.clientLanguage, MouseRecorder.archive2);
							HealthBar.HitSplatDefinition_cached = new class485(GameBuild.field3841, 47,
									TriBool.clientLanguage, MouseRecorder.archive2);
						...
						if (class304.compass == null) {
							class304.compass = class107.SpriteBuffer_getSprite(class180.archive8,
									FontName.spriteIds.compass, 0);
						} else {
							++var18;
						}

						if (class404.redHintArrowSprite == null) {
							class404.redHintArrowSprite = class107.SpriteBuffer_getSprite(class180.archive8,
									FontName.spriteIds.field4654, 0);
						} else {
							++var18;
						}
						...
						if (NPCComposition.headIconPkSprites == null) {
							NPCComposition.headIconPkSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.headIconsPk, 0);
						} else {
							++var18;
						}

						if (class157.headIconPrayerSprites == null) {
							class157.headIconPrayerSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.field4657, 0);
						} else {
							++var18;
						}

						if (ReflectionCheck.headIconHintSprites == null) {
							ReflectionCheck.headIconHintSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.field4658, 0);
						} else {
							++var18;
						}

						if (LoginScreenAnimation.mapMarkerSprites == null) {
							LoginScreenAnimation.mapMarkerSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.field4655, 0);
						} else {
							++var18;
						}

						if (class12.crossSprites == null) {
							class12.crossSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.field4660, 0);
						} else {
							++var18;
						}

						if (class19.mapDotSprites == null) {
							class19.mapDotSprites = WorldMapScaleHandler.method5597(class180.archive8,
									FontName.spriteIds.field4661, 0);
						} else {
							++var18;
						}
						...
						if (!Language.field4347.isFullyLoaded()) {
							...
							Messages.textureProvider = new TextureProvider(Language.field4347, class180.archive8, 20,
									class10.clientPreferences.method2430(), Client.isLowDetail ? 64 : 128);
						...
						if (!BuddyRankComparator.archive4.isFullyLoaded()) {
							Login.Login_loadingText = "Loading interfaces - "
									+ BuddyRankComparator.archive4.loadPercent() * 4 / 5 + "%";
							Login.Login_loadingPercent = 96;
						} else if (!class33.archive12.isFullyLoaded()) {
							Login.Login_loadingText = "Loading interfaces - "
									+ (80 + class33.archive12.loadPercent() / 6) + "%";
							Login.Login_loadingPercent = 96;
						} else if (!class310.archive13.isFullyLoaded()) {
							Login.Login_loadingText = "Loading interfaces - "
									+ (96 + class310.archive13.loadPercent() / 50) + "%";
							Login.Login_loadingPercent = 96;
						} else {
						...
						if (ChatChannel.archive19.getGroupCount() > 0
								&& !ChatChannel.archive19.tryLoadGroupByName(WorldMapCacheName.field3049.name)) {
							Login.Login_loadingText = "Loading world map - "
									+ ChatChannel.archive19.groupLoadPercentByName(WorldMapCacheName.field3049.name)
											/ 10
									+ "%";
						} else {
							if (ScriptFrame.worldMap == null) {
								ScriptFrame.worldMap = new WorldMap();
								ScriptFrame.worldMap.init(ChatChannel.archive19, class350.archive18, class291.archive20,
										class166.fontBold12, Client.fontsMap, class47.mapSceneSprites);
							}
	...
	static final void worldToMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		...
		if (var6 > 4225 && var6 < 90000) {
			...
			byte var17 = 20;
			class404.redHintArrowSprite.method9412(var15 + (var0 + var5.width / 2 - var17 / 2),
					var5.height / 2 + var1 - var17 / 2 - var16 - 10, var17, var17, 15, 15, var12, 256);
		} else {
