...
public abstract class class445 implements class279 {
	...
	public void method8211(Buffer var1) {
		while (true) {
			...
			class441[] var3 = new class441[] { class441.field4704, class441.field4706, class441.field4705,
					class441.field4702 };
			...
			if (var4 != null) {
				...
				case 3:
					class350[] var5 = new class350[] { class350.field4192, class350.field4190, class350.field4195,
							class350.field4193 };
	...
	static void loginScreen(GameEngine var0, Font var1, Font var2) {
		if (Login.worldSelectOpen) {
			...
			if ((MouseHandler.MouseHandler_lastButton == 1
					...
					&& MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50
					&& MouseHandler.MouseHandler_lastPressedY >= 453) {
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					if (Language.Language_EN == TriBool.clientLanguage) {
						if (MouseHandler.MouseHandler_lastButton == 1
							...
							var7 = 100;
							byte var8 = 35;
							if (MouseHandler.MouseHandler_lastPressedX >= var5
									&& MouseHandler.MouseHandler_lastPressedX <= var7 + var5
									&& MouseHandler.MouseHandler_lastPressedY >= var6
									&& MouseHandler.MouseHandler_lastPressedY <= var6 + var8) {
					...
					if (Login.loginIndex == 0) {
						...
						var44 = 291;
						if (var5 == 1 && var6 >= var10 - 75 && var6 <= var10 + 75 && var7 >= var44 - 20
								&& var7 <= var44 + 20) {
							class27.openURL(Widget.method6509("secure", true)
						...
						if (Login.loginIndex == 1) {
							while (true) {
								if (!var25.method4133()) {
									...
									var45 = 321;
									if (var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75 && var7 >= var45 - 20
											&& var7 <= var45 + 20) {
										ViewportMouse.Login_promptCredentials(false);
									}
							...
							if (Login.loginIndex == 2) {
								...
								if (FriendsList.field4572 != null) {
									...
									if (var5 == 1 && var6 >= FriendsList.field4572.lowX - var10
											&& var6 <= var10 + FriendsList.field4572.lowX && var7 >= var43 - 15
											&& var7 < var43) {
										switch (Login.field929) {
										case 1:
											class478.setLoginResponseString("Please enter your username.",
								...
								var44 = 277;
								Login.field947 = var6 >= var10 && var6 < var10 + class251.field2858 && var7 >= var44
										&& var7 < var44 + class60.field443;
								if (var5 == 1 && Login.field947) {
									Client.Login_isUsernameRemembered = !Client.Login_isUsernameRemembered;
									if (!Client.Login_isUsernameRemembered
											&& class10.clientPreferences.method2529() != null) {
								...
								var44 = 277;
								Login.field941 = var6 >= var10 && var6 < var10 + class251.field2858 && var7 >= var44
										&& var7 < var44 + class60.field443;
								...
								label1388: while (true) {
									...
									do {
										while (true) {
												...
												while (true) {
													while (var25.method4133()) {
														if (var25.field2349 != 13) {
															...
															for (var13 = 0; var13 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																	.length()
																	&& var47 != "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																			.charAt(var13); ++var13) {
															}

															if (var25.field2349 == 85
																	&& Login.Login_username.length() > 0) {
																Login.Login_username = Login.Login_username.substring(0,
																		Login.Login_username.length() - 1);
															}
															...
															boolean var48 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																	.indexOf(var14) != -1;
															if (var48 && Login.Login_username.length() < 320) {
																Login.Login_username = Login.Login_username
																		+ var25.field2348;
															}
														} else {
															class390.method7249(0);
											...
											if (var25.field2349 == 85 && Login.Login_password.length() > 0) {
												Login.Login_password = Login.Login_password.substring(0,
														Login.Login_password.length() - 1);
											} else if (var25.field2349 == 84 || var25.field2349 == 80) {
												Login.currentLoginField = 0;
												if (var25.field2349 == 84) {
													Login.Login_username = Login.Login_username.trim();
													if (Login.Login_username.length() == 0) {
														class478.setLoginResponseString("",
											...
											if ((var25.method4134(82) || var25.method4134(87))
													&& var25.field2349 == 67) {
											...
											if (ClanChannelMember.method3135(var25.field2348)) {
												...
												var46 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
														.indexOf(var49) != -1;
									...
									try {
										...
										while (true) {
											...
											boolean var18;
											if (var52 >= ' ' && var52 < 127 || var52 > 127 && var52 < 160
													|| var52 > 160 && var52 <= 255) {
												var18 = true;
											} else {
												label1528: {
											...
											boolean var28 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
													.indexOf(var55) != -1;
											if (!var28) {
												break;
											}
								...
								if (Login.loginIndex == 3) {
									...
									var9 = Login.loginBoxX + 180;
									var10 = 276;
									if (var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75 && var7 >= var10 - 20
											&& var7 <= var10 + 20) {
									...
									if (Login.loginIndex == 4) {
										...
										if (var5 == 1 && var6 >= Login.loginBoxX + 180 - 9
												&& var6 <= Login.loginBoxX + 180 + 130 && var7 >= 263 && var7 <= 296) {
											Login.field942 = !Login.field942;
										}

										if (var5 == 1 && var6 >= Login.loginBoxX + 180 - 34
												&& var6 <= Login.loginBoxX + 34 + 180 && var7 >= 351 && var7 <= 363) {
											class27.openURL(Widget.method6509("secure", true)
										...
										while (var25.method4133()) {
											...
											if (var25.field2349 == 13) {
												...
												if (var25.field2349 == 85 && SoundSystem.otp.length() > 0) {
													SoundSystem.otp = SoundSystem.otp.substring(0,
															SoundSystem.otp.length() - 1);
												}
										...
										if (Calendar.field3770 != null) {
											...
											if (var5 == 1 && var6 >= Calendar.field3770.lowX - var12
													&& var6 <= var12 + Calendar.field3770.lowX && var7 >= var44 - 15
													&& var7 < var44) {
												class27.openURL(Widget.method6509("secure", true)
														+ "m=weblogin/g=oldscape/cant_log_in", true, false);
											}
										}
										...
										while (var25.method4133()) {
											...
											for (var13 = 0; var13 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
													.length(); ++var13) {
												if (var25.field2348 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
														.charAt(var13)) {
													var46 = true;
													break;
												}
										...
										if (Login.loginIndex == 7) {
											if (class112.field1401 && !Client.onMobile) {
												...
												var44 = 231;
												var12 = var44 + 40;
												if (var5 == 1 && var6 >= var9 && var6 <= var10 && var7 >= var44
														&& var7 <= var12) {
												...
												Date var59;
												if (var5 == 1 && var6 >= var13 - 75 && var6 <= var13 + 75
														&& var7 >= var14 - 20 && var7 <= var14 + 20) {
													label1222: {
														try {
															...
															while (true) {
																if (var21 < var20.length) {
																	...
																	class478.setLoginResponseString("Date not valid.",
																			"Please ensure all characters are populated.",
																			"");
																	var33 = null;
																} else {
																	var31.append("12");
															...
															class390.method7249(7);
															class478.setLoginResponseString("Date not valid.",
																	"Please ensure date follows the format",
																	"DD/MM/YYYY and is after 01/01/1900");
															var35 = false;
															break label1222;
														}
														...
														if (var34 == null) {
															...
															if (!var19) {
																...
																if (!var17) {
																	...
																	GameObject.field2850 = (int) (var34.getTime()
																			/ 86400000L - 11745L);
																}
												...
												while (var25.method4133()) {
													...
													if (var25.field2349 == 85) {
														if (Login.field938[Login.field935] == null
																&& Login.field935 > 0) {
															--Login.field935;
														}
													...
													if (var25.field2349 == 84) {
														label1151: {
															try {
																var30 = new SimpleDateFormat("ddMMyyyyHH",
																		Locale.ENGLISH);
																var30.setLenient(false);
																var31 = new StringBuilder();
																var20 = Login.field938;
												...
												var9 = Login.loginBoxX + 180 - 80;
												var10 = 321;
												if (var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75
														&& var7 >= var10 - 20 && var7 <= var10 + 20) {
													class27.openURL(
															Widget.method6509("secure", true) + "m=dob/set_dob.ws",
															true, false);
													class478.setLoginResponseString("",
															"Page has opened in the browser.", "");
											...
											var9 = Login.loginBoxX + 180;
											var45 = 311;
											if (var25.field2349 == 84 || var25.field2349 == 13
													|| var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75
															&& var7 >= var45 - 20 && var7 <= var45 + 20) {
												class164.method3362(false);
											}
											...
											var9 = Login.loginBoxX + 180;
											var45 = 209;
											if (var25.field2349 == 84 || var5 == 1 && var6 >= var9 - 109
													&& var6 <= var9 + 109 && var7 >= var45 && var7 <= var45 + 68) {
												class478.setLoginResponseString("", "Connecting to server...", "");
											...
											var45 = 233;
											var29 = var2.method7425(0, 30,
													"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
													var9, var45);
											Bounds var26 = var2.method7425(32, 32,
													"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
													var9, var45);
											Bounds var27 = var2.method7425(70, 34,
													"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
													var9, var45);
											var10 = var45 + 17;
											Bounds var37 = var2.method7425(0, 34, "<col=ffd200>agreement (EULA)</col>.",
													var9, var10);
											if (var5 == 1) {
												if (var29.method8029(var6, var7)) {
													...
													class27.openURL("https://www.jagex.com/terms/privacy", true, false);
												} else if (var27.method8029(var6, var7)
														|| var37.method8029(var6, var7)) {
													class27.openURL(
															"https://www.jagex.com/en-GB/legal/eula-runescape-oldschool",
															true, false);
												}
											}
											...
											var44 = 276;
											if (var5 == 1 && var6 >= var10 - 75 && var6 <= var10 + 75
													&& var7 >= var44 - 20 && var7 <= var44 + 20) {
											...
											if (var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75
													&& var7 >= var45 - 20 && var7 <= var45 + 20) {
												class27.openURL(Widget.method6509("secure", true) + "m=dob/set_dob.ws",
														true, false);
												class478.setLoginResponseString("", "Page has opened in the browser.",
														"");
												class390.method7249(6);
											...
											if (var5 == 1 && var6 >= var9 - 75 && var6 <= var9 + 75
													&& var7 >= var45 - 20 && var7 <= var45 + 20) {
												class27.openURL("https://oldschool.runescape.com/launcher", true,
														false);
											}
