				...
				label369: {
					...
					if (var18 == 2 && class36.scene.getObjectFlags(Clock.Client_plane, var15, var16, var26) >= 0) {
						...
						for (PendingSpawn var22 = (PendingSpawn) Client.pendingSpawns
								.last(); var22 != null; var22 = (PendingSpawn) Client.pendingSpawns.previous()) {
							if (var22.plane == Clock.Client_plane && var15 == var22.x && var17 == var22.y
									&& var19 == var22.field1148) {
								var21 = var22;
								break;
							}
						}
						...
						if (Client.isItemSelected == 1) {
							class138.insertMenuItemNoShift("Use",
									Client.field667 + " " + "->" + " " + Strings.colorStartTag(65535) + var20.name, 1,
									var19, var15, var17);
						} else if (Client.isSpellSelected) {
							if ((class125.selectedSpellFlags & 4) == 4) {
								class138.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName
										+ " " + "->" + " " + Strings.colorStartTag(65535) + var20.name, 2, var19, var15,
										var17);
							}
						} else {
							...
							if (var35 != null) {
								for (var23 = 4; var23 >= 0; --var23) {
									if ((var21 == null || var21.method2351(var23)) && var35[var23] != null) {
										...
										class138.insertMenuItemNoShift(var35[var23],
												Strings.colorStartTag(65535) + var20.name, var24, var19, var15, var17);
									}
								}
							}

							class138.insertMenuItemNoShift("Examine", Strings.colorStartTag(65535) + var20.name, 1002,
									var20.id, var15, var17);
						}
					}
					...
					if (var18 == 1) {
						...
						if (var31.definition.size == 1 && (var31.x & 127) == 64 && (var31.y & 127) == 64) {
							for (var28 = 0; var28 < Client.npcCount; ++var28) {
								...
								if (var36 != null && var31 != var36 && var36.definition.size == 1 && var31.x == var36.x
										&& var36.y == var31.y) {
					...
					if (var18 == 0) {
						...
						if ((var32.x & 127) == 64 && (var32.y & 127) == 64) {
							for (var28 = 0; var28 < Client.npcCount; ++var28) {
								var36 = Client.npcs[Client.npcIndices[var28]];
								if (var36 != null && var36.definition.size == 1 && var36.x == var32.x
										&& var32.y == var36.y) {
									Language.addNpcToMenu(var36, Client.npcIndices[var28], var15, var17);
								}
							}
					...
					if (var18 == 3) {
						...
						if (var33 != null) {
							for (TileItem var34 = (TileItem) var33.first(); var34 != null; var34 = (TileItem) var33
									.next()) {
								ItemComposition var38 = class300.ItemDefinition_get(var34.id);
								if (Client.isItemSelected == 1) {
									class138.insertMenuItemNoShift("Use", Client.field667 + " " + "->" + " "
											+ Strings.colorStartTag(16748608) + var38.name, 16, var34.id, var15, var17);
								} else if (Client.isSpellSelected) {
									if ((class125.selectedSpellFlags & 1) == 1) {
										class138.insertMenuItemNoShift(Client.selectedSpellActionName,
												Client.selectedSpellName + " " + "->" + " "
														+ Strings.colorStartTag(16748608) + var38.name,
												17, var34.id, var15, var17);
									}
								} else {
									...
									for (var24 = 4; var24 >= 0; --var24) {
										if (var34.method2661(var24)) {
											if (var30 != null && var30[var24] != null) {
												...
												class138.insertMenuItemNoShift(var30[var24],
														Strings.colorStartTag(16748608) + var38.name, var25, var34.id,
														var15, var17);
											} else if (var24 == 2) {
												class138.insertMenuItemNoShift("Take",
														Strings.colorStartTag(16748608) + var38.name, 20, var34.id,
														var15, var17);
											}
										}
									}

									class138.insertMenuItemNoShift("Examine",
											Strings.colorStartTag(16748608) + var38.name, 1004, var34.id, var15, var17);
								}
							}
						}
					}
