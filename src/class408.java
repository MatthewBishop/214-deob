...
class class408 implements Comparator {
	...
	static final void method7686() {
		...
		if (UserComparator8.field1415 == class208.cameraX && WallDecoration.field2828 == class152.cameraY
				&& Clock.field1883 == ByteArrayPool.cameraZ && Clock.field1884 == MusicPatchNode.cameraPitch
				&& class53.field368 == class291.cameraYaw) {
