		...
		if (!var0.isValidFileName(var2, var3)) {
			...
			if (!var7) {
				...
				if (var9 == null) {
					...
					Font var10 = new Font(var9, class515.SpriteBuffer_xOffsets, class402.SpriteBuffer_yOffsets,
							class515.SpriteBuffer_spriteWidths, class515.SpriteBuffer_spriteHeights,
							class515.SpriteBuffer_spritePalette, class515.SpriteBuffer_pixels);
