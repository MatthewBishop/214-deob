...
public enum class137 implements MouseWheel {
	...
	static final void method3090(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 256) != 0) {
			...
			PlayerType var8 = (PlayerType) GameObject.findEnumerated(HealthBarDefinition.PlayerType_values(),
					var0.readUnsignedByteAdd());
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var12 && Client.field626 == 0 && !var2.isHidden) {
					...
					Players.field1342.offset = 0;
					String var13 = AbstractFont
							.escapeBrackets(class290.method5660(class16.method218(Players.field1342)));
					...
					var2.field1165 = var9;
					var2.field1174 = var2 != Projectile.localPlayer && var8.isUser && "" != Client.field736
							&& var13.toLowerCase().indexOf(Client.field736) == -1;
					...
					if (var8.modIcon != -1) {
						class59.addGameMessage(var15, class100.method2624(var8.modIcon) + var2.username.getName(),
								var13);
					} else {
		...
		if ((var3 & 2048) != 0) {
			...
			class216[] var17 = new class216[] { class216.field2394, class216.field2395, class216.field2396,
					class216.field2397 };
		...
		if ((var3 & 64) != 0) {
			...
			PlayerType var18 = (PlayerType) GameObject.findEnumerated(HealthBarDefinition.PlayerType_values(),
					var0.readUnsignedByteAdd());
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var23 && Client.field626 == 0 && !var2.isHidden) {
					...
					var2.field1174 = var2 != Projectile.localPlayer && var18.isUser && "" != Client.field736
							&& var20.toLowerCase().indexOf(Client.field736) == -1;
					...
					if (var18.modIcon != -1) {
						class59.addGameMessage(var24, class100.method2624(var18.modIcon) + var2.username.getName(),
								var20);
					} else {
		...
		if (var2.field1124) {
			if (var4 == 127) {
				...
				if (var4 != class216.field2397.field2393) {
					class216[] var28 = new class216[] { class216.field2394, class216.field2395, class216.field2396,
							class216.field2397 };
