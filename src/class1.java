			...
			if (Client.menuOptionsCount < 400) {
				...
				if (Client.isItemSelected == 1) {
					class138.insertMenuItemNoShift("Use",
							Client.field667 + " " + "->" + " " + Strings.colorStartTag(16777215) + var4, 14, var1, var2,
							var3);
				} else if (Client.isSpellSelected) {
					if ((class125.selectedSpellFlags & 8) == 8) {
						class138.insertMenuItemNoShift(Client.selectedSpellActionName,
								Client.selectedSpellName + " " + "->" + " " + Strings.colorStartTag(16777215) + var4,
								15, var1, var2, var3);
					}
				} else {
					for (var10 = 7; var10 >= 0; --var10) {
						if (Client.playerMenuActions[var10] != null) {
							...
							if (Client.playerMenuActions[var10].equalsIgnoreCase("Attack")) {
								...
								if (AttackOption.AttackOption_alwaysRightClick == Client.playerAttackOption
										|| AttackOption.AttackOption_dependsOnCombatLevels == Client.playerAttackOption
												&& var0.combatLevel > Projectile.localPlayer.combatLevel) {
									var11 = 2000;
								}
							...
							class138.insertMenuItemNoShift(Client.playerMenuActions[var10],
									Strings.colorStartTag(16777215) + var4, var7, var1, var2, var3);
						}
					}
				}
