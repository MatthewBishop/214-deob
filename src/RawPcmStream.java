public class RawPcmStream extends PcmStream {
	...
	int method873(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field350 > 0) {
				...
				if (this.field338 == 256 && (this.field345 & 255) == 0) {
					if (class347.PcmPlayer_stereo) {
						var2 = method922(0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
								this.field343, this.field348, this.field351, 0, var6, var3, this);
					} else {
						var2 = method884(((RawSound) super.sound).samples, var1, this.field345, var2, this.field341,
								this.field349, 0, var6, var3, this);
					}
				} else if (class347.PcmPlayer_stereo) {
					var2 = method871(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
							this.field343, this.field348, this.field351, 0, var6, var3, this, this.field338, var5);
				} else {
					var2 = method888(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field341,
							this.field349, 0, var6, var3, this, this.field338, var5);
				}
			...
			if (this.field338 == 256 && (this.field345 & 255) == 0) {
				if (class347.PcmPlayer_stereo) {
					return method877(0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
							this.field343, 0, var4, var3, this);
				}

				return method913(((RawSound) super.sound).samples, var1, this.field345, var2, this.field341, 0, var4,
						var3, this);
			}

			if (class347.PcmPlayer_stereo) {
				return method881(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
						this.field343, 0, var4, var3, this, this.field338, var5);
			}

			return method880(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field341, 0, var4,
					var3, this, this.field338, var5);
		}
	}
	...
	int method874(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field350 > 0) {
				...
				if (this.field338 == -256 && (this.field345 & 255) == 0) {
					if (class347.PcmPlayer_stereo) {
						var2 = method887(0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
								this.field343, this.field348, this.field351, 0, var6, var3, this);
					} else {
						var2 = method956(((RawSound) super.sound).samples, var1, this.field345, var2, this.field341,
								this.field349, 0, var6, var3, this);
					}
				} else if (class347.PcmPlayer_stereo) {
					var2 = method891(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
							this.field343, this.field348, this.field351, 0, var6, var3, this, this.field338, var5);
				} else {
					var2 = method890(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field341,
							this.field349, 0, var6, var3, this, this.field338, var5);
				}
			...
			if (this.field338 == -256 && (this.field345 & 255) == 0) {
				if (class347.PcmPlayer_stereo) {
					return method879(0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
							this.field343, 0, var4, var3, this);
				}

				return method878(((RawSound) super.sound).samples, var1, this.field345, var2, this.field341, 0, var4,
						var3, this);
			}

			if (class347.PcmPlayer_stereo) {
				return method883(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field342,
						this.field343, 0, var4, var3, this, this.field338, var5);
			}

			return method882(0, 0, ((RawSound) super.sound).samples, var1, this.field345, var2, this.field341, 0, var4,
					var3, this, this.field338, var5);
		}
	}
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0,
				(int) ((long) var0.sampleRate * 256L * (long) var1 / (long) (PcmPlayer.field291 * 100)), var2 << 6)
				: null;
	}
	...
	static int method913(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			RawPcmStream var8) {
		var2 >>= 8;
		var7 >>= 8;
		var4 <<= 2;
	...
	static int method877(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method878(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			RawPcmStream var8) {
		var2 >>= 8;
		var7 >>= 8;
		var4 <<= 2;
	...
	static int method879(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, RawPcmStream var10) {
		var3 >>= 8;
		var9 >>= 8;
		var5 <<= 2;
	...
	static int method880(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method881(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method882(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, RawPcmStream var10, int var11, int var12) {
	...
	static int method883(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, RawPcmStream var11, int var12, int var13) {
	...
	static int method884(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			RawPcmStream var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method922(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method956(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			RawPcmStream var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method887(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, RawPcmStream var12) {
		var3 >>= 8;
		var11 >>= 8;
		var5 <<= 2;
	...
	static int method888(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, RawPcmStream var11, int var12, int var13) {
	...
	static int method871(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method890(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field342 -= var11.field348 * var5;
		var11.field343 -= var11.field351 * var5;
		if (var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) {
	...
	static int method891(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field341 -= var5 * var13.field349;
