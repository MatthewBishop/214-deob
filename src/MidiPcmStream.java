...
public class MidiPcmStream extends PcmStream {
			...
			if (var9.rawSounds[var2] != null) {
				...
				if (var5 != null) {
					...
					if (this.field3424[var1] == 0) {
						var6.stream = RawPcmStream.method949(var5, this.method5761(var6), this.method5762(var6),
								this.method5763(var6));
					} else {
	...
	int method5761(MusicPatchNode var1) {
		...
		var4 = (int) ((double) (var1.rawSound.sampleRate * 256) * Math.pow(2.0, (double) var2 * 3.255208333333333E-4)
				/ (double) PcmPlayer.field291 + 0.5);
	...
	int method5762(MusicPatchNode var1) {
		...
		if (var2.field3373 > 0) {
			var3 = (int) ((double) var3 * Math.pow(0.5, (double) var2.field3373 * 1.953125E-5 * (double) var1.field3486)
					+ 0.5);
		}
	...
	int method5763(MusicPatchNode var1) {
		...
		return var2 < 8192 ? var2 * var1.field3482 + 32 >> 6
				: 16384 - ((128 - var1.field3482) * (16384 - var2) + 32 >> 6);
	}
	...
	boolean method5771(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3489 < 0 || var1.stream != null && !var1.stream.method951()) {
			...
			if (var5 > 0) {
				var5 -= (int) (16.0 * Math.pow(2.0, (double) this.field3420[var1.field3490] * 4.921259842519685E-4)
						+ 0.5);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double) ((var1.field3480 - 60 << 8) + (var1.field3485 * var1.field3484 >> 12))
			...
			if (var6.field3374 != null) {
				...
				while (var1.field3488 * 4 < var6.field3374.length - 2
						&& var1.field3487 > (var6.field3374[var1.field3488 * 4 + 2] & 255) << 8) {
			...
			if (var1.field3489 >= 0 && var6.field3381 != null && (this.field3421[var1.field3490] & 1) == 0
					&& (var1.field3479 < 0 || var1 != this.field3428[var1.field3490][var1.field3479])) {
				if (var6.field3376 > 0) {
				...
				while (var1.field3495 * 4 < var6.field3381.length - 2
						&& var1.field3489 > (var6.field3381[var1.field3495 * 4 + 2] & 255) << 8) {
