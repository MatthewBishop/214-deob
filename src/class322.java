public class class322 {
	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			int var9 = -2;
			if (var0.overheadText != null && (!var8 || !var0.field1174 && (Client.publicChatMode == 4
					|| !var0.field1165 && (Client.publicChatMode == 0 || Client.publicChatMode == 3
							|| Client.publicChatMode == 1 && ((Player) var0).isFriend())))) {
				UserList.method7862(var0, var0.defaultHeight);
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
					Client.overheadTextXOffsets[Client.overheadTextCount] = class166.fontBold12
							.stringWidth(var0.overheadText) / 2;
			...
			if (!var0.healthBars.method7007()) {
				...
				for (HealthBar var10 = (HealthBar) var0.healthBars
						.last(); var10 != null; var10 = (HealthBar) var0.healthBars.previous()) {
					...
					if (var11 == null) {
						...
						if (var79 != null && var83 != null) {
							...
							if (Client.viewportTempX > -1) {
								...
								Rasterizer2D.Rasterizer2D_fillRectangle(var88 + var98, var22, var15 - var98, 5,
										16711680);
							}
			...
			if (var8 && var0.playerCycle == Client.cycle && WorldMapRegion.method5288((Player) var0)) {
				...
				if (var8) {
					...
					var9 += 4;
					var90.drawCentered(var89.username.getName(), var2 + Client.viewportTempX,
							var3 + Client.viewportTempY - var9, 16777215, 0);
					var9 += 18;
				}
			}
			...
			if (var8) {
				...
				if (var89.headIconPk != -1 || var89.headIconPrayer != -1) {
					...
					if (Client.viewportTempX > -1) {
						if (var89.headIconPk != -1) {
							var9 += 25;
							NPCComposition.headIconPkSprites[var89.headIconPk].drawTransBgAt(
									var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var9);
						}

						if (var89.headIconPrayer != -1) {
							var9 += 25;
							class157.headIconPrayerSprites[var89.headIconPrayer].drawTransBgAt(
									var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var9);
						}
					}
				}
				...
				if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) {
					...
					if (Client.viewportTempX > -1) {
						...
						ReflectionCheck.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12,
								var3 + Client.viewportTempY - var9);
					}
				}
			} else {
				NPC var91 = (NPC) var0;
				...
				if (var93 != null && var92 != null) {
					for (int var13 = 0; var13 < var93.length; ++var13) {
						if (var93[var13] >= 0 && var92[var13] >= 0) {
							...
							if (var16 == null) {
								SpritePixels[] var17 = WorldMapScaleHandler.method5597(class180.archive8, var92[var13],
										0);
							...
							if (var16 != null) {
								UserList.method7862(var0, var0.defaultHeight + 15);
								if (Client.viewportTempX > -1) {
									var16.drawTransBgAt(var2 + Client.viewportTempX - (var16.subWidth >> 1),
											Client.viewportTempY + (var3 - var16.subHeight) - 4);
								}
							}
						}
					}
				...
				if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var75] == Client.hintArrowNpcIndex
						&& Client.cycle % 20 < 10) {
					UserList.method7862(var0, var0.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
						ReflectionCheck.headIconHintSprites[0].drawTransBgAt(var2 + Client.viewportTempX - 12,
								var3 + Client.viewportTempY - 28);
					}
				}
			}
