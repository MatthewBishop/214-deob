...
public class class7 {
	...
	static final void method51(String var0) {
		PacketBufferNode var1 = ObjectComposition.getPacketBufferNode(ClientPacket.FRIEND_ADDUSER,
	...
	static final void method44() {
		...
		for (int var11 = 0; var11 < Client.rootWidgetCount; ++var11) {
			if (Client.rootWidgetWidths[var11] + Client.rootWidgetXs[var11] > var7
					&& Client.rootWidgetXs[var11] < var7 + var9
					&& Client.rootWidgetHeights[var11] + Client.rootWidgetYs[var11] > var8
					&& Client.rootWidgetYs[var11] < var10 + var8) {
	...
	static final void Clan_joinChat(String var0) {
		if (!var0.equals("")) {
			PacketBufferNode var1 = ObjectComposition.getPacketBufferNode(ClientPacket.field3128,
					Client.packetWriter.isaacCipher);
			var1.packetBuffer.writeByte(Widget.stringCp1252NullTerminatedByteSize(var0));
			var1.packetBuffer.writeStringCp1252NullTerminated(var0);
			Client.packetWriter.addNode(var1);
