...
public class class47 {
	...
	static void method844() {
		...
		class478.setLoginResponseString("The game servers are currently being updated.",
	...
	static void method845(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != Projectile.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					var8 = ObjectComposition.getPacketBufferNode(ClientPacket.OPPLAYER1,
							Client.packetWriter.isaacCipher);
					var8.packetBuffer.writeByteSub(0);
					var8.packetBuffer.writeShortAdd(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 4) {
					var8 = ObjectComposition.getPacketBufferNode(ClientPacket.OPPLAYER4,
							Client.packetWriter.isaacCipher);
					var8.packetBuffer.writeShortLE(var3[var6]);
					var8.packetBuffer.writeByteAdd(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 6) {
					var8 = ObjectComposition.getPacketBufferNode(ClientPacket.OPPLAYER6,
							Client.packetWriter.isaacCipher);
					var8.packetBuffer.writeByteNeg(0);
					var8.packetBuffer.writeShort(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 7) {
					var8 = ObjectComposition.getPacketBufferNode(ClientPacket.OPPLAYER7,
							Client.packetWriter.isaacCipher);
