...
public class class59 {
	...
	void method1112(float[] var1, int var2) {
		...
		for (var6 = 2; var6 < var3; ++var6) {
			...
			var9 = this.field428.method744(this.field430[var7], this.field431[var7], this.field430[var8],
					this.field431[var8], this.field430[var6]);
	...
	static final void drawSpriteOnMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		if (var4 != null) {
			...
			if (var7 <= 6400) {
				...
				if (var7 > 2500) {
					var4.method9410(var10 + var5.width / 2 - var4.width / 2, var5.height / 2 - var11 - var4.height / 2,
