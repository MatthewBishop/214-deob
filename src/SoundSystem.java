public class SoundSystem implements Runnable {
	...
	static void method815(float[] var0) {
		...
		if (var0[0] > 1.0F || var0[1] > 1.0F) {
			float var1 = (float) (1.0 + ((double) var0[1] - 2.0) * (double) var0[1]
					+ (double) (var0[0] * (var0[0] - 2.0F + var0[1])));
	...
	static class90[] method817() {
		return new class90[] { class90.field1090, class90.field1096, class90.field1091, class90.field1094,
				class90.field1093, class90.field1092 };
	}
