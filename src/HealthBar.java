...
public class HealthBar extends Node {
			...
			if (var6 == null) {
				...
				if (!var5) {
					...
					if (class125.field1468 == null) {
						...
						class125.field1468 = new ThreadPoolExecutor(0, AccessFile.field4940, 0L, TimeUnit.MILLISECONDS,
								new ArrayBlockingQueue(AccessFile.field4940 * 100 + 100), new class183());
					}
	...
	static final void method2549() {
		...
		if (Client.oculusOrbState == 0) {
			...
			if (ModeWhere.oculusOrbFocalPointX - var0 < -500 || ModeWhere.oculusOrbFocalPointX - var0 > 500
					|| GrandExchangeEvents.oculusOrbFocalPointY - var1 < -500
					|| GrandExchangeEvents.oculusOrbFocalPointY - var1 > 500) {
			...
			var4 = Renderable.getTileHeight(ModeWhere.oculusOrbFocalPointX, GrandExchangeEvents.oculusOrbFocalPointY,
					Clock.Client_plane);
			var5 = 0;
			int var6;
			...
			Login.field917 = Renderable.getTileHeight(Projectile.localPlayer.x, Projectile.localPlayer.y,
					Clock.Client_plane) - Client.camFollowHeight;
			...
			if (Client.field602 && Projectile.localPlayer != null) {
				...
				if (var0 >= 0 && var1 >= 0 && var0 < 104 && var1 < 104) {
					...
					var2 = Renderable.getTileHeight(Projectile.localPlayer.x, Projectile.localPlayer.y,
							Clock.Client_plane) - Client.camFollowHeight;
			...
			if (Client.field739.method4134(13)) {
				Client.packetWriter.addNode(ObjectComposition.getPacketBufferNode(ClientPacket.FREECAM_EXIT,
		...
		if (MouseHandler.MouseHandler_currentButton == 4 && class305.mouseCam) {
			...
			Client.mouseCamClickedY = var0 != -1 && var0 != 1
					? (MouseHandler.MouseHandler_y + Client.mouseCamClickedY) / 2
					: MouseHandler.MouseHandler_y;
			var1 = Client.field727 - MouseHandler.MouseHandler_x;
			Client.camAngleDY = var1 * 2;
			Client.field727 = var1 != -1 && var1 != 1 ? (MouseHandler.MouseHandler_x + Client.field727) / 2
					: MouseHandler.MouseHandler_x;
		} else {
	...
	static void setWindowedMode(int var0) {
		...
		if (Client.gameState >= 25) {
			PacketBufferNode var1 = ObjectComposition.getPacketBufferNode(ClientPacket.EVENT_WINDOW_SETTING,
					Client.packetWriter.isaacCipher);
