final class class104 implements class321 {
	...
	static final void method2671(Actor var0) {
			...
			if (var1 != null) {
				if (!var1.isCachedModelIdSet() && var1.frameIds != null) {
					...
					if (var0.movementFrame < var1.frameIds.length
							&& var0.movementFrameCycle > var1.frameLengths[var0.movementFrame]) {
					...
					if (var0.movementFrame >= var1.frameIds.length) {
						if (var1.frameCount > 0) {
							...
							if (var0.movementFrame < 0 || var0.movementFrame >= var1.frameIds.length
									|| var1.field2296 && var0.field1195 >= var1.field2297) {
					...
					if (var0.movementFrame < var2) {
						...
						if (var1.frameCount > 0) {
							...
							if (var0.movementFrame < 0 || var0.movementFrame >= var2
									|| var1.field2296 && var0.field1195 >= var1.field2297) {
								var0.movementFrame = 0;
								var0.movementFrameCycle = 0;
								var0.field1195 = 0;
				...
				if (var3 == -1) {
					...
					if (var4.frameIds != null && !var4.isCachedModelIdSet()) {
						...
						if (var6.spotAnimationFrame < var4.frameIds.length
								&& var6.spotAnimationFrameCycle > var4.frameLengths[var6.spotAnimationFrame]) {
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
			...
			if (var8.field2287 == 1 && var0.field1226 > 0 && var0.spotAnimation <= Client.cycle
					&& var0.field1208 < Client.cycle) {
			...
			if (var8 != null) {
				if (!var8.isCachedModelIdSet() && var8.frameIds != null) {
					...
					if (var0.sequenceFrame < var8.frameIds.length
							&& var0.sequenceFrameCycle > var8.frameLengths[var0.sequenceFrame]) {
