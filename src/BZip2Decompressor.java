public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized (BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field5060 = 0;
	...
	static void method9193(BZip2State var0) {
		...
		int var13 = var0.field5060;
		var0.field5060 += var10 - var10;
		if (var0.field5060 < var13) {
		}
		...
		var0.su_ch2 = var5;
		Clock.BZip2Decompressor_block = var6;
		var0.field5045 = var7;
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (Clock.BZip2Decompressor_block == null) {
			Clock.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
		...
		while (true) {
			while (var26) {
				...
				for (var36 = 0; var36 < var41; ++var36) {
					...
					var27[0] = (byte) var28;
					var0.selector[var36] = (byte) var28;
				}

				int var38;
				for (var38 = 0; var38 < var40; ++var38) {
					int var49 = BZip2Decompressor_readBits(5, var0);

					for (var36 = 0; var36 < var39; ++var36) {
						while (true) {
							var1 = BZip2Decompressor_readNextBit(var0);
							if (var1 == 0) {
								var0.temp_charArray2d[var38][var36] = (byte) var49;
								break;
							}
				...
				for (var38 = 0; var38 < var40; ++var38) {
					...
					BZip2Decompressor_createHuffmanTables(var0.limit[var38], var0.base[var38], var0.perm[var38],
							var0.temp_charArray2d[var38], var2, var3, var39);
				...
				for (var35 = 15; var35 >= 0; --var35) {
					for (var28 = 15; var28 >= 0; --var28) {
						var0.ll8[var29] = (byte) (var28 + var35 * 16);
						--var29;
					}

					var0.getAndMoveToFrontDecode_yy[var35] = var29 + 1;
				}
				...
				if (var44 == 0) {
					++var43;
					var44 = 50;
					var53 = var0.selector[var43];
					var22 = var0.minLens[var53];
					var23 = var0.limit[var53];
					var25 = var0.perm[var53];
					var24 = var0.base[var53];
				}
				...
				int var51;
				byte var52;
				for (var51 = BZip2Decompressor_readBits(var22, var0); var51 > var23[var50]; var51 = var51 << 1
						| var52) {
					++var50;
					var52 = BZip2Decompressor_readNextBit(var0);
				}
				...
				while (true) {
						...
						if (var45 != 0 && var45 != 1) {
							...
							if (var33 < 16) {
								...
								for (var10002 = var0.getAndMoveToFrontDecode_yy[var31]++; var31 > 0; --var31) {
									...
									var0.ll8[var0.getAndMoveToFrontDecode_yy[var31]] = var0.ll8[var0.getAndMoveToFrontDecode_yy[var31
											- 1] + 16 - 1];
								}
								...
								if (var0.getAndMoveToFrontDecode_yy[0] == 0) {
									...
									for (var35 = 15; var35 >= 0; --var35) {
										for (var28 = 15; var28 >= 0; --var28) {
											var0.ll8[var29] = var0.ll8[var0.getAndMoveToFrontDecode_yy[var35] + var28];
											--var29;
										}
							...
							Clock.BZip2Decompressor_block[var46] = var0.seqToUnseq[var1 & 255] & 255;
							++var46;
							if (var44 == 0) {
								++var43;
								var44 = 50;
							...
							for (var51 = BZip2Decompressor_readBits(var22,
									var0); var51 > var23[var50]; var51 = var51 << 1 | var52) {
								++var50;
								var52 = BZip2Decompressor_readNextBit(var0);
							}
							...
							for (var10000[var1 & 255] += var47; var47 > 0; --var47) {
								Clock.BZip2Decompressor_block[var46] = var1 & 255;
								++var46;
							}
						}
					}
					...
					for (var36 = 0; var36 < var46; ++var36) {
						var1 = (byte) (Clock.BZip2Decompressor_block[var36] & 255);
						var10000 = Clock.BZip2Decompressor_block;
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++;
					}

					var0.field5045 = Clock.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field5045 = Clock.BZip2Decompressor_block[var0.field5045];
					var0.su_ch2 = (byte) (var0.field5045 & 255);
					var0.field5045 >>= 8;
					++var0.nblocks_used;
					var0.field5063 = var46;
					method9193(var0);
					if (var0.field5063 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
	...
	static void BZip2Decompressor_createHuffmanTables(int[] var0, int[] var1, int[] var2, byte[] var3, int var4,
			int var5, int var6) {
		int var7 = 0;
