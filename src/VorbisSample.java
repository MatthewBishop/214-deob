	...
	float[] method1056(int var1) {
		...
		if (!var18.method1110()) {
			...
			for (var48 = 0; var48 < var21; ++var48) {
				var23[var48] = var23[var20 + var48 * 2] * var25[var48 * 2]
						+ var23[var20 + var48 * 2 + 1] * var25[var48 * 2 + 1];
				var23[var20 - 1 - var48] = var23[var20 + var48 * 2] * var25[var48 * 2 + 1]
						- var23[var20 + var48 * 2 + 1] * var25[var48 * 2];
			}
			...
			for (var48 = var12; var48 < var13; ++var48) {
				var30 = (float) Math
						.sin(((double) (var48 - var12) + 0.5) / (double) var14 * 0.5 * Math.PI + 1.5707963267948966);
				var57 = this.field400;
				var57[var48] *= (float) Math.sin(1.5707963267948966 * (double) var30 * (double) var30);
			}
		}
