public final class WorldMapSprite {
	...
	static void getLoginError(int var0) {
		...
		if (var0 == -3) {
			...
			Login.field929 = 2;
			class478.setLoginResponseString("Either your account is still logged in, or the last",
					"world you were using has become unavailable.", "Please try again later.");
			...
			class478.setLoginResponseString("We suspect someone knows your password.",
					"Press 'change your password' on front page.", "");
		} else if (var0 == 12) {
			class478.setLoginResponseString("You need a members account to login to this world.",
			...
			class478.setLoginResponseString("Too many login attempts.",
					"You can use the Jagex Launcher to continue playing.",
					"Press the button below to download it now.");
			class390.method7249(33);
		} else if (var0 == 17) {
			class478.setLoginResponseString("To access this free world, log into a",
					"members world and move your character", "to a non-members area.");
		} else if (var0 == 18) {
			class390.method7249(14);
			Login.Login_banType = 1;
		} else if (var0 == 19) {
			class478.setLoginResponseString("This world is running a closed Beta.", "Sorry invited players only.",
			...
			class478.setLoginResponseString("This computers address has been blocked",
					"as it was used to break our rules.", "");
		} else if (var0 == 27) {
			class478.setLoginResponseString("", "Service unavailable.", "");
		} else if (var0 == 31) {
			class478.setLoginResponseString("Your account must have a displayname set",
					"in order to play the game.  Please set it", "via the website, or the main game.");
		} else if (var0 == 32) {
			class390.method7249(14);
			Login.Login_banType = 2;
		} else if (var0 == 37) {
			class478.setLoginResponseString("Your account is currently inaccessible.",
					"Please try again in a few minutes.", "");
		} else if (var0 == 38) {
			class478.setLoginResponseString("You need to vote to play!", "Visit runescape.com and vote,",
			...
			if (var0 == 61) {
				...
				if (var0 == 71) {
					UserComparator8.updateGameState(10);
					class390.method7249(7);
					class478.setLoginResponseString("There was a problem updating your DOB.",
							"Please try again later. If the problem ", "persists, please contact Jagex Support.");
				} else if (var0 == 73) {
					UserComparator8.updateGameState(10);
					class390.method7249(6);
					class478.setLoginResponseString("Your date of birth information is waiting",
							"to be reviewed by our staff.", "It will be processed shortly.");
				} else if (var0 == 72) {
					UserComparator8.updateGameState(10);
