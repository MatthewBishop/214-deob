...
public class Instrument {
	...
	final int[] synthesize(int var1, int var2) {
		class397.clearIntArray(Instrument_samples, 0, var1);
		if (var2 < 10) {
			...
			for (var11 = 0; var11 < 5; ++var11) {
				if (this.oscillatorVolume[var11] != 0) {
					...
					Instrument_pitchSteps[var11] = (int) ((double) (this.pitch.end - this.pitch.start) * 32.768
							* Math.pow(1.0057929410678534, (double) this.oscillatorPitch[var11]) / var3);
					Instrument_pitchBaseSteps[var11] = (int) ((double) this.pitch.start * 32.768 / var3);
				}
			}
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.oscillatorVolume[var14] != 0) {
						...
						if (var15 < var1) {
							...
							var10000[var15] += this.evaluateWave(Instrument_phases[var14],
									var13 * Instrument_volumeSteps[var14] >> 15, this.pitch.form);
							var10000 = Instrument_phases;
							var10000[var14] += (var12 * Instrument_pitchSteps[var14] >> 16)
									+ Instrument_pitchBaseSteps[var14];
						}
					}
				}
			}
			...
			if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) {
				...
				if (var1 >= var12 + var13) {
					...
					int var17;
					while (var14 < var15) {
						var16 = (int) ((long) Instrument_samples[var14 + var12]
								* (long) AudioFilter.forwardMultiplier >> 16);

						for (var17 = 0; var17 < var12; ++var17) {
							var16 += (int) ((long) Instrument_samples[var14 + var12 - 1 - var17]
									* (long) AudioFilter.coefficients[0][var17] >> 16);
						}

						for (var17 = 0; var17 < var14; ++var17) {
							var16 -= (int) ((long) Instrument_samples[var14 - 1 - var17]
									* (long) AudioFilter.coefficients[1][var17] >> 16);
						}
					...
					while (true) {
						...
						int var18;
						while (var14 < var15) {
							var17 = (int) ((long) Instrument_samples[var14 + var12]
									* (long) AudioFilter.forwardMultiplier >> 16);

							for (var18 = 0; var18 < var12; ++var18) {
								var17 += (int) ((long) Instrument_samples[var14 + var12 - 1 - var18]
										* (long) AudioFilter.coefficients[0][var18] >> 16);
							}

							for (var18 = 0; var18 < var13; ++var18) {
								var17 -= (int) ((long) Instrument_samples[var14 - 1 - var18]
										* (long) AudioFilter.coefficients[1][var18] >> 16);
							}
	...
	final void decode(Buffer var1) {
		...
		this.filter.method1097(var1, this.filterEnvelope);
	}
}
