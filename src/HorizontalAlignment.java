...
public enum HorizontalAlignment implements MouseWheel {
	...
	static void method3679(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
		if (Login.clearLoginScreen) {
			...
			ParamComposition.field2110 = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(var1,
					"titlebutton_large", "");
			...
			class104.options_buttons_0Sprite = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(var1,
					"options_radio_buttons,0", "");
			DynamicObject.field1008 = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(var1,
					"options_radio_buttons,4", "");
			class177.options_buttons_2Sprite = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(var1,
