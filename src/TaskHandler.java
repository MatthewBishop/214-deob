			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !UserComparator9.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (class10.clientPreferences.method2448()) {
									var13 += 15;
									class404.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width,
											var13, 16776960, -1);
									var13 += 15;
									...
									class404.fontPlain12.drawRightAligned("Mem:" + var20 + "k", var12 + var10.width,
											var13, var21, -1);
									var13 += 15;
								}
								continue;
						...
						if (var10.type == 0) {
							if (!var10.isIf3 && UserComparator9.isComponentHidden(var10)
									&& var10 != ClanChannel.mousedOverWidgetIf1) {
								continue;
							}
							...
							drawInterface(var0, var10.id, var15, var16, var17, var18, var12 - var10.scrollX,
									var13 - var10.scrollY, var11);
							if (var10.children != null) {
								drawInterface(var10.children, var10.id, var15, var16, var17, var18,
										var12 - var10.scrollX, var13 - var10.scrollY, var11);
							}
						...
						if (Client.isResizable || Client.field743[var11] || Client.gameDrawingMode > 1) {
							if (var10.type == 0 && !var10.isIf3 && var10.scrollHeight > var10.height) {
								WorldMapLabelSize.drawScrollBar(var12 + var10.width, var13, var10.scrollY, var10.height,
										var10.scrollHeight);
							}
							...
							if (var10.type != 1) {
								if (var10.type == 3) {
									...
									if (var10.fill) {
										...
										case 1:
											Rasterizer2D.Rasterizer2D_fillRectangleGradient(var12, var13, var10.width,
													var10.height, var10.color, var10.color2);
											break;
										case 2:
											Rasterizer2D.Rasterizer2D_fillRectangleGradientAlpha(var12, var13,
													var10.width, var10.height, var10.color, var10.color2,
													255 - (var10.transparencyTop & 255),
													255 - (var10.transparencyBot & 255));
											break;
										default:
											if (var14 == 0) {
												Rasterizer2D.Rasterizer2D_fillRectangle(var12, var13, var10.width,
														var10.height, var19);
											} else {
												Rasterizer2D.Rasterizer2D_fillRectangleAlpha(var12, var13, var10.width,
														var10.height, var19, 256 - (var14 & 255));
											}
										}
									} else if (var14 == 0) {
										Rasterizer2D.Rasterizer2D_drawRectangle(var12, var13, var10.width, var10.height,
												var19);
									} else {
										Rasterizer2D.Rasterizer2D_drawRectangleAlpha(var12, var13, var10.width,
												var10.height, var19, 256 - (var14 & 255));
									}
									...
									if (var40 == null) {
										...
										if (ItemComposition.runCs1(var10)) {
											var20 = var10.color2;
											if (var10 == ClanChannel.mousedOverWidgetIf1
													&& var10.mouseOverColor2 != 0) {
										...
										if (var10.isIf3 && var10.itemId != -1) {
											...
											if ((var43.isStackable == 1 || var10.itemQuantity != 1)
													&& var10.itemQuantity != -1) {
												var42 = Strings.colorStartTag(16748608) + var42 + "</col>" + " " + 'x'
														+ class346.formatItemStacks(var10.itemQuantity);
											}
										}
										...
										var40.method7431(var42, var12, var13, var10.width, var10.height, var20,
												var10.textShadowed ? 0 : -1, class388.method7210(var10.transparencyTop),
												var10.textXAlignment, var10.textYAlignment, var10.textLineHeight);
									}
								} else {
									int var23;
									int var24;
									...
									if (var10.type == 5) {
										SpritePixels var38;
										if (!var10.isIf3) {
											var38 = var10.getSprite(ItemComposition.runCs1(var10),
													class47.urlRequester);
											if (var38 != null) {
											...
											if (var10.itemId != -1) {
												var38 = ScriptEvent.getItemSprite(var10.itemId, var10.itemQuantity,
														var10.outline, var10.spriteShadow, var10.itemQuantityMode,
														false);
											} else {
											...
											if (var38 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var38.method9438(var10.width / 2 + var12,
																var10.height / 2 + var13, var10.spriteAngle, var22);
													} else if (var14 != 0) {
														var38.drawTransScaledAt(var12, var13, var10.width, var10.height,
																256 - (var14 & 255));
													...
													Rasterizer2D.Rasterizer2D_expandClip(var12, var13,
															var12 + var10.width, var13 + var10.height);
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var38.method9438(var20 / 2 + var12 + var20 * var24,
																		var21 / 2 + var13 + var21 * var25,
																		var10.spriteAngle, 4096);
															} else if (var14 != 0) {
																var38.drawTransAt(var12 + var24 * var20,
																		var13 + var25 * var21, 256 - (var14 & 255));
															} else {
																var38.drawTransBgAt(var12 + var24 * var20,
																		var13 + var25 * var21);
															}
														}
													}
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												if (var10.modelId == 0) {
													var39 = Client.playerAppearance.getModel((SequenceDefinition) null,
															-1, (SequenceDefinition) null, -1);
												} else {
													var39 = Projectile.localPlayer.getModel();
												}
											} else if (var10.modelType == 7) {
												var39 = var10.field3631.getModel((SequenceDefinition) null, -1,
														WorldMapLabelSize.SequenceDefinition_get(
																Projectile.localPlayer.idleSequence),
														Projectile.localPlayer.movementFrame);
											} else {
												...
												var39 = var10.getModel(var35, var26, var36,
														Projectile.localPlayer.appearance, var45, var33);
											...
											if (var39 != null) {
												if (!var10.isIf3) {
													var39.method4798(0, var10.modelAngleY, 0, var10.modelAngleX, 0,
															var23, var24);
												} else {
													var39.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														var39.method4799(0, var10.modelAngleY, var10.modelAngleZ,
																var10.modelAngleX, var10.modelOffsetX,
																var22 + var23 + var10.modelOffsetY,
																var24 + var10.modelOffsetY, var10.modelZoom);
													} else {
														var39.method4798(0, var10.modelAngleY, var10.modelAngleZ,
																var10.modelAngleX, var10.modelOffsetX,
																var22 + var23 + var10.modelOffsetY,
																var24 + var10.modelOffsetY);
													}
												}
											}
											...
											Font var29;
											if (var10.type == 8 && var10 == class19.field99
													&& Client.field665 == Client.field664) {
												var19 = 0;
												var20 = 0;
												...
												String var31;
												for (var30 = BuddyRankComparator.method2892(var30, var10); var30
														.length() > 0; var20 = var20 + var29.ascent + 1) {
												...
												Rasterizer2D.Rasterizer2D_fillRectangle(var24, var25, var19, var20,
														16777120);
												...
												for (var30 = BuddyRankComparator.method2892(var30, var10); var30
														.length() > 0; var26 = var26 + var29.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													Rasterizer2D.Rasterizer2D_drawLine(var19, var20, var21, var22,
															var10.color);
												} else {
													class129.method3001(var19, var20, var21, var22, var10.color,
															var10.lineWid);
												}
												...
												if (var37 != null && var32 != null && var37.method6238()) {
													var29 = var10.getFont();
													if (var29 != null) {
														Client.field715.method9539(var12, var13, var10.width,
																var10.height, var37.method6157(), var37.method6114(),
																var37.method6239(), var37.method6232(),
																var37.method6109());
														var22 = var10.textShadowed ? var10.spriteShadow : -1;
														if (!var37.method6107() && var37.method6163().method7410()) {
															Client.field715.method9547(var32.field3520, var22,
																	var32.field3522, var32.field3519);
															Client.field715.method9545(var37.method6105(), var29);
														} else {
															Client.field715.method9547(var10.color, var22,
																	var32.field3522, var32.field3519);
