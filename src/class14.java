...
public class class14 {
	...
	final ThreadPoolExecutor method172(int var1) {
		return new ThreadPoolExecutor(var1, var1, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(this.field72),
				this.field71);
	}

	public class18 method173(class10 var1) {
		if (this.field70.getQueue().remainingCapacity() <= 0) {
			System.err.println("REST thread pool queue is empty\r\nThread pool size " + this.field70.getCorePoolSize()
					+ " Queue capacity " + this.field72);
	...
	static boolean method183(String var0, int var1, String var2) {
		if (var1 == 0) {
			...
			try {
				class31.field162.getAppletContext().showDocument(new URL(class31.field162.getCodeBase(), var0),
						"_blank");
				return true;
