...
public final class ObjectSound extends Node {
	...
	static class127[] method1875() {
		return new class127[] { class127.field1494, class127.field1486, class127.field1487, class127.field1488,
				class127.field1491 };
	}

	static int method1881(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.WORLDLIST_FETCH) {
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class497.loadWorlds() ? 1
					: 0;
			return 1;
		} else {
			World var9;
				...
				if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) {
					...
					if (var0 == ScriptOpcodes.SETFOLLOWEROPSLOWPRIORITY) {
						...
						if (var0 == ScriptOpcodes.NC_PARAM) {
							...
							if (var5.isString()) {
								Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = Bounds
										.getNpcDefinition(var3).getStringParam(var4, var5.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Bounds
										.getNpcDefinition(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
										- 1] = class175.getObjectDefinition(var3).getStringParam(var4, var5.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class175
										.getObjectDefinition(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
										- 1] = class300.ItemDefinition_get(var3).getStringParam(var4, var5.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class300
										.ItemDefinition_get(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
										- 1] = class139.StructDefinition_getStructDefinition(var3).getStringParam(var4,
												var5.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class139
										.StructDefinition_getStructDefinition(var3).getIntParam(var4, var5.defaultInt);
							}
