...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5,
			IndexedSprite[] var6) {
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapRenderer.method5319(this.centerTileX - var8 / 2 - 1,
						this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1,
						var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2);
			...
			if (!this.hasTarget() && (var4 || var3)) {
				...
				if (!var7) {
					...
					if (this.field4837 != -1) {
						...
						this.setWorldMapPosition(this.field4837 - (int) ((float) var8 / this.zoomTarget),
								(int) ((float) var9 / this.zoomTarget) + this.field4864, false);
					}
					break label40;
				}
			}
	...
	void method8434(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) {
			int var6 = (int) ((float) this.centerTileX
					+ ((float) (var1 - this.worldMapDisplayX) - (float) this.getDisplayWith() * this.zoom / 2.0F)
							/ this.zoom);
			int var7 = (int) ((float) this.centerTileY
					- ((float) (var2 - this.worldMapDisplayY) - (float) this.getDisplayHeight() * this.zoom / 2.0F)
							/ this.zoom);
			this.mouseCoord = this.currentMapArea.coord(var6 + this.currentMapArea.getRegionLowX() * 64,
					var7 + this.currentMapArea.getRegionLowY() * 64);
			if (this.mouseCoord != null && var3) {
				...
				if (RouteStrategy.method4214() && var8.method4134(82) && var8.method4134(81)) {
					...
					PacketBufferNode var12 = ObjectComposition.getPacketBufferNode(ClientPacket.field3182,
					...
					if (var9) {
						PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.field3106,
								Client.packetWriter.isaacCipher);
	...
	void initializeWorldMap(WorldMapArea var1) {
		...
		this.worldMapRenderer = new WorldMapRenderer(this.mapSceneSprites, this.fonts, this.WorldMap_geographyArchive,
				this.WorldMap_groundArchive);
	...
	void jump(int var1, int var2, int var3) {
		if (this.currentMapArea != null) {
			...
			if (var4 == null) {
				var4 = this.currentMapArea.position(this.currentMapArea.getOriginPlane(),
						this.currentMapArea.getOriginX(), this.currentMapArea.getOriginY());
			}

			this.setWorldMapPosition(var4[0] - this.currentMapArea.getRegionLowX() * 64,
					var4[1] - this.currentMapArea.getRegionLowY() * 64, true);
			this.worldMapTargetX = -1;
			this.worldMapTargetY = -1;
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			if (!this.worldMapRenderer.isLoaded()) {
				this.worldMapRenderer.load(this.WorldMap_archive, this.currentMapArea.getInternalName(),
			...
			this.worldMapRenderer.drawTiles(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
					var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4);
			if (!this.elementsDisabled) {
				...
				this.worldMapRenderer.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
						var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4,
						this.field4874, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}
	...
	void method8406(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (class30.field152 != null) {
			...
			if (this.method8500(var8, var9, var13, var14, var3, var4)) {
				...
				class30.field152.method6878(this.minCachedTileX, this.minCachedTileY, this.sprite,
						(float) this.cachedPixelsPerTile / var10);
	...
	public void drawOverview(int var1, int var2, int var3, int var4) {
		if (this.cacheLoader.isLoaded()) {
			...
			this.worldMapRenderer.drawOverview(var1, var2, var3, var4, this.flashingElements, this.flashCycle,
					this.cyclesPerFlash);
		}
	}
	...
	public void setWorldMapPositionTargetInstant(int var1, int var2) {
		if (this.currentMapArea != null) {
			this.setWorldMapPosition(var1 - this.currentMapArea.getRegionLowX() * 64,
					var2 - this.currentMapArea.getRegionLowY() * 64, true);
			this.worldMapTargetX = -1;
			this.worldMapTargetY = -1;
		}
	}
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapRenderer.method5319(this.centerTileX - var7 / 2 - 1,
					this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1,
				...
				do {
					...
					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) {
						if (var12.menuActions[var14] != null) {
							class138.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName,
									this.menuOpcodes[var14], var11.getElement(), var11.coord1.packed(),
									var11.coord2.packed());
							var13 = true;
						}
					}
