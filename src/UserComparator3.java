public class UserComparator3 extends AbstractUserComparator {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6,
		...
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method6456() || StudioGame.getWidgetFlags(var9) != 0
					|| var9 == Client.clickedWidgetParent)) {
				if (var9.isIf3) {
					if (UserComparator9.isComponentHidden(var9)) {
						continue;
					}
				} else if (var9.type == 0 && var9 != ClanChannel.mousedOverWidgetIf1
						&& UserComparator9.isComponentHidden(var9)) {
					continue;
				}
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
					if (var9.isIf3) {
						...
						if (var9.noClickThrough) {
							if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13
									&& MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								for (var27 = (ScriptEvent) Client.scriptEvents
										.last(); var27 != null; var27 = (ScriptEvent) Client.scriptEvents.previous()) {
									if (var27.field1062) {
										var27.remove();
						...
						} else if (var9.noScrollThrough && MouseHandler.MouseHandler_x >= var12
								&& MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
								&& MouseHandler.MouseHandler_y < var15) {
							for (var27 = (ScriptEvent) Client.scriptEvents
									.last(); var27 != null; var27 = (ScriptEvent) Client.scriptEvents.previous()) {
					...
					if (var9.contentType == 1337) {
						...
						if (var9.contentType == 1400) {
							ScriptFrame.worldMap.onCycle(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y,
									var35, var26, var11, var9.width, var9.height);
						}

						if (!Client.isMenuOpen && var35) {
							if (var9.contentType == 1400) {
								ScriptFrame.worldMap.addElementMenuOptions(var26, var11, var9.width, var9.height, var17,
										var18);
							} else {
						...
						if (var34) {
							for (int var20 = 0; var20 < var9.field3678.length; ++var20) {
								...
								if (!var21 && var9.field3678[var20] != null) {
									for (var23 = 0; var23 < var9.field3678[var20].length; ++var23) {
										...
										if (FaceNormal.method4720(var9.field3678[var20][var23]) || var24) {
											...
											if (var33 == 0 || ((var33 & 8) == 0 || !Client.field739.method4134(86)
													&& !Client.field739.method4134(82)
													&& !Client.field739.method4134(81))
													&& ((var33 & 2) == 0 || Client.field739.method4134(86))
													&& ((var33 & 1) == 0 || Client.field739.method4134(82))
													&& ((var33 & 4) == 0 || Client.field739.method4134(81))) {
												var28 = true;
												break;
											}
										}
								...
								if (var28) {
									if (var20 < 10) {
										InvDefinition.widgetDefaultMenuAction(var20 + 1, var9.id, var9.childIndex,
												var9.itemId, "");
									} else if (var20 == 10) {
										FriendsList.Widget_runOnTargetLeave();
										FriendLoginUpdate.selectSpell(var9.id, var9.childIndex, LoginScreenAnimation
												.Widget_unpackTargetMask(StudioGame.getWidgetFlags(var9)), var9.itemId);
										Client.selectedSpellActionName = BuddyRankComparator
												.Widget_getSpellActionName(var9);
						...
						if (var9.isIf3) {
							...
							if ((MouseHandler.MouseHandler_currentButton == 1
									|| !class305.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35) {
								var36 = true;
							}
							...
							if ((MouseHandler.MouseHandler_lastButton == 1
									...
									&& MouseHandler.MouseHandler_lastPressedX >= var12
									&& MouseHandler.MouseHandler_lastPressedY >= var13
									&& MouseHandler.MouseHandler_lastPressedX < var14
									&& MouseHandler.MouseHandler_lastPressedY < var15) {
								var21 = true;
							}

							if (var21) {
								UserComparator10.clickWidget(var9, MouseHandler.MouseHandler_lastPressedX - var26,
										MouseHandler.MouseHandler_lastPressedY - var11);
							}

							if (var9.method6363()) {
								if (var21) {
									Client.field742.addFirst(new class210(0, MouseHandler.MouseHandler_x - var26,
											MouseHandler.MouseHandler_y - var11, var9));
								}

								if (var36) {
									Client.field742.addFirst(new class210(1, MouseHandler.MouseHandler_x - var26,
											MouseHandler.MouseHandler_y - var11, var9));
								}
							}
							...
							if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35
									&& class145.method3147(StudioGame.getWidgetFlags(var9))) {
							...
							if (var9.hasListener) {
								...
								if (var9.onVarTransmit != null && Client.changedVarpCount > var9.field3743) {
									if (var9.varTransmitTriggers != null
											&& Client.changedVarpCount - var9.field3743 <= 32) {
										label827: for (var39 = var9.field3743; var39 < Client.changedVarpCount; ++var39) {
								...
								if (var9.onInvTransmit != null && Client.field701 > var9.field3744) {
									if (var9.invTransmitTriggers != null && Client.field701 - var9.field3744 <= 32) {
										label803: for (var39 = var9.field3744; var39 < Client.field701; ++var39) {
								...
								if (var9.onStatTransmit != null && Client.changedSkillsCount > var9.field3601) {
									if (var9.statTransmitTriggers != null
											&& Client.changedSkillsCount - var9.field3601 <= 32) {
										label779: for (var39 = var9.field3601; var39 < Client.changedSkillsCount; ++var39) {
						...
						if (!var9.isIf3) {
							...
							if ((var9.mouseOverRedirect >= 0 || var9.mouseOverColor != 0)
									&& MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13
									&& MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
							...
							if (var9.type == 8 && MouseHandler.MouseHandler_x >= var12
									&& MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
									&& MouseHandler.MouseHandler_y < var15) {
							...
							if (var9.scrollHeight > var9.height) {
								class20.method304(var9, var26 + var9.width, var11, var9.height, var9.scrollHeight,
										MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y);
							}
						}

						if (var9.type == 0) {
							updateInterface(var0, var9.id, var12, var13, var14, var15, var26 - var9.scrollX,
									var11 - var9.scrollY);
							if (var9.children != null) {
								updateInterface(var9.children, var9.id, var12, var13, var14, var15,
										var26 - var9.scrollX, var11 - var9.scrollY);
							}

							InterfaceParent var29 = (InterfaceParent) Client.interfaceParents.get((long) var9.id);
							if (var29 != null) {
								if (var29.type == 0 && MouseHandler.MouseHandler_x >= var12
										&& MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
										&& MouseHandler.MouseHandler_y < var15 && !Client.isMenuOpen) {
									for (ScriptEvent var30 = (ScriptEvent) Client.scriptEvents
											.last(); var30 != null; var30 = (ScriptEvent) Client.scriptEvents
													.previous()) {
										if (var30.field1062) {
											var30.remove();
								...
								RouteStrategy.updateRootInterface(var29.group, var12, var13, var14, var15, var26,
										var11);
							}
						}
					}
