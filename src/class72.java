...
public class class72 {
	...
	static final BigInteger field890 = new BigInteger(
			"80782894952180643741752986186714059433953886149239752893425047584684715842049");

	static final BigInteger field891 = new BigInteger(
	...
	public static int method2044(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5,
			float[] var6) {
		float var7 = 0.0F;
	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class213.baseX * 64 + var4.pathX[0] >> 13 << 14)
						+ (class101.baseY * 64 + var4.pathY[0] >> 13);
				if (var4.field1228 != -1) {
