public class Decimator {
	...
	static LoginPacket[] method1086() {
		return new LoginPacket[] { LoginPacket.field3345, LoginPacket.field3342, LoginPacket.field3343,
				LoginPacket.field3346, LoginPacket.field3347, LoginPacket.field3344 };
	}
	...
	static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				class33.sceneMinimapSprite.drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height, var6,
						var7, var5, 256, var4.xStarts, var4.xWidths);
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var15 != null && var15.isVisible() && !var15.isHidden && var15 != Projectile.localPlayer) {
						...
						} else if (Projectile.localPlayer.team != 0 && var15.team != 0
								&& var15.team == Projectile.localPlayer.team) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0
							&& Client.hintArrowNpcIndex < Client.npcs.length) {
						...
						if (var19 != null) {
							...
							class136.worldToMinimap(var1, var2, var11, var12, LoginScreenAnimation.mapMarkerSprites[1],
									var4);
						}
					}
					...
					if (Client.hintArrowType == 2) {
						...
						class136.worldToMinimap(var1, var2, var10, var11, LoginScreenAnimation.mapMarkerSprites[1],
								var4);
					}

					if (Client.hintArrowType == 10 && Client.hintArrowPlayerIndex >= 0
							&& Client.hintArrowPlayerIndex < Client.players.length) {
				...
				if (Client.destinationX != 0) {
					...
					class59.drawSpriteOnMinimap(var1, var2, var10, var11, LoginScreenAnimation.mapMarkerSprites[0],
							var4);
				}

				if (!Projectile.localPlayer.isHidden) {
					Rasterizer2D.Rasterizer2D_fillRectangle(var4.width / 2 + var1 - 1, var4.height / 2 + var2 - 1, 3, 3,
							16777215);
				}
			} else {
