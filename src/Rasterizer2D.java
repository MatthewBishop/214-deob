public class Rasterizer2D extends DualNode {
	...
	protected static void method9246(int[] var0, int var1, int var2, float[] var3) {
	...
	static void Rasterizer2D_setPixel(int var0, int var1, int var2) {
		if (var0 >= Rasterizer2D_xClipStart && var1 >= Rasterizer2D_yClipStart && var0 < Rasterizer2D_xClipEnd
				&& var1 < Rasterizer2D_yClipEnd) {
	...
	public static void method9269() {
		if (field5088 != null) {
			...
			int var1;
			int var2;
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width
					&& Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field5088.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field5088[var2++] = 0.0F) {
					field5088[var2++] = 0.0F;
					field5088[var2++] = 0.0F;
					field5088[var2++] = 0.0F;
					field5088[var2++] = 0.0F;
	...
	public static void method9270() {
		if (field5088 != null) {
			int var0 = field5088.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5088[var1] > 0.0F) {
					float var3 = field5088[var1];
					float var4 = 75.0F;
					float var5 = 10000.0F;
