			...
			if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
				...
				if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
					...
					if (GrandExchangeOfferUnitPriceComparator.grandExchangeEvents != null) {
						GrandExchangeOfferUnitPriceComparator.grandExchangeEvents
								.sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator, var12);
					}
					...
					if (GrandExchangeOfferUnitPriceComparator.grandExchangeEvents != null) {
						GrandExchangeOfferUnitPriceComparator.grandExchangeEvents
								.sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator, var12);
					}
					...
					if (GrandExchangeOfferUnitPriceComparator.grandExchangeEvents != null) {
						...
						GrandExchangeOfferUnitPriceComparator.grandExchangeEvents
								.sort(Client.GrandExchangeEvents_worldComparator, var12);
					}
					...
					if (GrandExchangeOfferUnitPriceComparator.grandExchangeEvents != null) {
						GrandExchangeOfferUnitPriceComparator.grandExchangeEvents
								.sort(GrandExchangeEvents.GrandExchangeEvents_ageComparator, var12);
					}
					...
					if (GrandExchangeOfferUnitPriceComparator.grandExchangeEvents != null) {
						GrandExchangeOfferUnitPriceComparator.grandExchangeEvents
								.sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator, var12);
					}

					return 1;
				} else if (var0 == ScriptOpcodes.TRADINGPOST_GETTOTALOFFERS) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = GrandExchangeOfferUnitPriceComparator.grandExchangeEvents == null ? 0
									: GrandExchangeOfferUnitPriceComparator.grandExchangeEvents.events.size();
					return 1;
				} else {
					GrandExchangeEvent var4;
					if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var4 = (GrandExchangeEvent) GrandExchangeOfferUnitPriceComparator.grandExchangeEvents.events
								.get(var3);
						...
						var4 = (GrandExchangeEvent) GrandExchangeOfferUnitPriceComparator.grandExchangeEvents.events
								.get(var3);
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = var4.grandExchangeOffer.totalQuantity;
						return 1;
						...
						var4 = (GrandExchangeEvent) GrandExchangeOfferUnitPriceComparator.grandExchangeEvents.events
								.get(var3);
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = var4.grandExchangeOffer.unitPrice;
						return 1;
						...
						var4 = (GrandExchangeEvent) GrandExchangeOfferUnitPriceComparator.grandExchangeEvents.events
								.get(var3);
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = var4.grandExchangeOffer.id;
						return 1;
					} else if (var0 == 3939) {
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class300.ItemDefinition_get(var3).isTradable ? 1 : 0;
						return 1;
					} else {
						return 2;
					}
	...
	static final void method14(boolean var0) {
		...
		if (Client.packetWriter.pendingWrites >= 50 || var0) {
			...
			if (!Client.hadNetworkError && Client.packetWriter.getSocket() != null) {
				PacketBufferNode var1 = ObjectComposition.getPacketBufferNode(ClientPacket.NO_TIMEOUT,
