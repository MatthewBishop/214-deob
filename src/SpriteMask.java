			...
			if (var5 == 22) {
				if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1 || var8.boolean2) {
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var29 = new DynamicObject(var3, 22, var4, var0, var1, var2, var8.animationId, var8.boolean3,
								(Renderable) null);
					}
				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var29 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.animationId,
						...
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var29 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.animationId, var8.boolean3,
									(Renderable) null);
						}

						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
								Tiles.field1021[var4], 0, var19, var21);
						if (var4 == 0) {
							if (var8.clipped) {
						...
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var29 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.animationId, var8.boolean3,
									(Renderable) null);
						}

						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
								Tiles.field1022[var4], 0, var19, var21);
						if (var8.clipped) {
							if (var4 == 0) {
								class305.Tiles_underlays2[var0][var1][var2 + 1] = 50;
							} else if (var4 == 1) {
						...
						if (var5 == 2) {
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var30 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.animationId,
										var8.boolean3, (Renderable) null);
								var24 = new DynamicObject(var3, 2, var22, var0, var1, var2, var8.animationId,
										var8.boolean3, (Renderable) null);
							}

							var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var30, (Renderable) var24,
									Tiles.field1021[var4], Tiles.field1021[var22], var19, var21);
							if (var8.modelClipped) {
								if (var4 == 0) {
									var10000 = Tiles.field1020[var0][var1];
									var10000[var2] |= 585;
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var29 = new DynamicObject(var3, 3, var4, var0, var1, var2, var8.animationId,
										var8.boolean3, (Renderable) null);
							}
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var29 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId,
										var8.boolean3, (Renderable) null);
							}

							var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
									Tiles.field1021[var4], 0, 0, 0, var19, var21);
						} else {
							long var23;
							Object var25;
							if (var5 == 5) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25, (Renderable) null,
										Tiles.field1021[var4], 0, var22 * Tiles.field1014[var4],
										var22 * Tiles.field1023[var4], var19, var21);
							} else if (var5 == 6) {
								var22 = 8;
								var23 = var6.getBoundaryObjectTag(var0, var1, var2);
								if (var23 != 0L) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25, (Renderable) null,
										256, var4, var22 * Tiles.field1025[var4], var22 * Tiles.field1026[var4], var19,
										var21);
							} else if (var5 == 7) {
								var28 = var4 + 2 & 3;
								if (var8.animationId == -1 && var8.transforms == null) {
									...
									var29 = new DynamicObject(var3, 4, var28 + 4, var0, var1, var2, var8.animationId,
											var8.boolean3, (Renderable) null);
								}

								var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
										256, var28, 0, 0, var19, var21);
							} else if (var5 == 8) {
								var22 = 8;
								var23 = var6.getBoundaryObjectTag(var0, var1, var2);
								if (0L != var23) {
					...
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var29 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.animationId, var8.boolean3,
								(Renderable) null);
					}

					if (var29 != null && var6.method4522(var0, var1, var2, var16, var9, var10, (Renderable) var29,
