...
public class ObjectComposition extends DualNode {
	...
	final ModelData getModelData(int var1, int var2) {
		...
		ModelData var8 = new ModelData(var3, var2 == 0 && !var4 && !var11, this.recolorFrom == null,
				null == this.retextureFrom, true);
		if (var1 == 4 && var2 > 3) {
			var8.method4308(256);
		...
		if (PcmPlayer.field291 == 0) {
			...
			try {
				...
				if (class260.field2944 > 0 && class382.soundSystem == null) {
					...
					PcmPlayer.soundSystemExecutor.scheduleAtFixedRate(class382.soundSystem, 0L, 10L,
