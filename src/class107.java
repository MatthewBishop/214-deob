...
public class class107 {
	...
	static final int method2701(int var0, int var1) {
		int var2 = GrandExchangeEvents.method6803(var0 + '넵', 91923 + var1, 4) - 128
				+ (GrandExchangeEvents.method6803(var0 + 10294, '鎽' + var1, 2) - 128 >> 1)
				+ (GrandExchangeEvents.method6803(var0, var1, 1) - 128 >> 2);
	...
	static int method2700(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			ServerPacket.performPlayerAnimation(Projectile.localPlayer,
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.RESUME_COUNTDIALOG,
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize];
					var11 = ObjectComposition.getPacketBufferNode(ClientPacket.RESUME_NAMEDIALOG,
							Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize];
					var11 = ObjectComposition.getPacketBufferNode(ClientPacket.RESUME_STRINGDIALOG,
							Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class10.clientPreferences.method2434() ? 1 : 0;
						return 1;
					} else if (var0 == ScriptOpcodes.SETREMOVEROOFS) {
						class10.clientPreferences.method2489(
								Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1);
						return 1;
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = ObjectComposition.getPacketBufferNode(ClientPacket.RESUME_OBJDIALOG,
								Client.packetWriter.isaacCipher);
						...
						if (var4.length() > 500) {
							...
							PacketBufferNode var6 = ObjectComposition.getPacketBufferNode(ClientPacket.field3150,
									Client.packetWriter.isaacCipher);
							var6.packetBuffer.writeShort(1 + Widget.stringCp1252NullTerminatedByteSize(var4)
									+ Widget.stringCp1252NullTerminatedByteSize(var5));
						...
						class105.setTapToDrop(
								Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1);
						return 1;
					} else if (var0 == ScriptOpcodes.GETTAPTODROP) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = SceneTilePaint
								.getTapToDrop() ? 1 : 0;
						return 1;
					} else if (var0 == 3129) {
						Interpreter.Interpreter_intStackSize -= 2;
						Client.oculusOrbNormalSpeed = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
						Client.oculusOrbSlowedSpeed = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
								+ 1];
						return 1;
					} else if (var0 == 3130) {
						Interpreter.Interpreter_intStackSize -= 2;
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class448.canvasWidth;
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = WorldMapID.canvasHeight;
						return 1;
						...
						if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = class10.clientPreferences.method2472() ? 1 : 0;
							return 1;
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = Client.Login_isUsernameRemembered ? 1 : 0;
							return 1;
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = class10.clientPreferences.method2437() ? 0 : 1;
							return 1;
						} else if (var0 == 3148) {
							return 1;
						} else if (var0 == 3149) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = Login.Login_loadingPercent;
							return 1;
						} else if (var0 == 3154) {
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = FriendLoginUpdate.method7786();
							return 1;
						} else if (var0 == 3155) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class60
									.method1119();
							return 1;
						} else if (var0 == 3189) {
							var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
