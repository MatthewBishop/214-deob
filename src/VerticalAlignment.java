...
public enum VerticalAlignment implements MouseWheel {
	...
	static int method3754(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.VIEWPORT_SETFOV) {
			...
			Client.field776 = (short) class389
					.method7215(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize]);
			if (Client.field776 <= 0) {
				Client.field776 = 256;
			}

			Client.field620 = (short) class389
					.method7215(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			...
			if (Client.viewportWidget != null) {
				WorldMapDecorationType.setViewportShape(0, 0, Client.viewportWidget.width, Client.viewportWidget.height,
						false);
			...
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = WorldMapRegion
					.method5289(Client.field776);
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = WorldMapRegion
					.method5289(Client.field620);
			return 1;
		} else if (var0 == 6220) {
