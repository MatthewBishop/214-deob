...
public class class156 extends class142 {
	...
	static int method3294(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.SOUND_SYNTH) {
			...
			SpriteMask.queueSoundEffect(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
					Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1],
					Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2]);
			return 1;
			...
			HealthBarUpdate.method2400(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
					Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			return 1;
		} else {
			class90 var3;
			...
			int var6;
			String var12;
			if (var0 != 3212 && var0 != 3213 && var0 != 3209 && var0 != 3181 && var0 != 3203 && var0 != 3205
					&& var0 != 3207) {
				boolean var13;
				if (var0 != 3214 && var0 != 3215 && var0 != 3210 && var0 != 3182 && var0 != 3204 && var0 != 3206
						&& var0 != 3208) {
					if (var0 == 3211) {
						return 1;
					} else {
						...
						if (var0 == 3216) {
							...
							var9 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
							var10 = 0;
							class89 var11 = (class89) GameObject.findEnumerated(WorldMapDecorationType.method6590(),
									var9);
							if (var11 != null) {
