...
public class NPCComposition extends DualNode {
	...
	public short method3735(int var1) {
		return this.headIconSpriteIndex != null && var1 < this.headIconSpriteIndex.length
				? this.headIconSpriteIndex[var1]
				: -1;
	}
			...
			if (var0 != ScriptOpcodes.DB_FINDNEXT) {
				...
				if (var0 == ScriptOpcodes.DB_GETFIELD) {
					...
					if (var21 >= 0) {
						if (var21 >= var13) {
							throw new RuntimeException(
									"Tuple index out-of-bounds. Requested: " + var21 + ", Max: " + var13);
						}
					...
					if (var14 == null) {
						for (var15 = var12; var15 < var13; ++var15) {
							...
							if (var22 == class490.field4976) {
								...
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class485
										.method8730(var16);
							}
						}
				...
				if (class218.field2404 != null && class218.field2404.hasNext()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = (Integer) class218.field2404.next();
				} else {
