public final class IndexedSprite extends Rasterizer2D {
	...
	public void drawAt(int var1, int var2) {
		...
		if (var6 > 0 && var5 > 0) {
			IndexedSprite_two(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var4, var3, var6, var5, var7,
					var8);
		}
	}

	public void method9367(int var1, int var2, int var3, int var4) {
		...
		IndexedSprite_something(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var7, var8, var13, var14,
				var3, var4, var11, var12, var5);
	}

	static void IndexedSprite_two(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	static void IndexedSprite_something(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6,
			int var7, int var8, int var9, int var10, int var11) {
		int var12 = var3;
