		...
		if (var0 == ScriptOpcodes.CC_CREATE) {
			...
			if (var0 == ScriptOpcodes.CC_DELETE) {
				...
				if (var0 == ScriptOpcodes.IF_FIND) {
					var3 = FriendSystem
							.getWidget(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
					if (var3 != null) {
	...
	static final void method1194(int var0, int var1, boolean var2) {
		if (Client.currentClanChannels[var0] != null) {
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method3346()) {
				...
				PacketBufferNode var4 = ObjectComposition.getPacketBufferNode(ClientPacket.field3152,
