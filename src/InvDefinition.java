public class InvDefinition extends DualNode {
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 0 || Client.gameState == 5) {
				var3 = 20;
				var0.drawCentered("RuneScape is loading - please wait...", Login.loginBoxX + 180, 245 - var3, 16777215,
						-1);
				var4 = 253 - var3;
				Rasterizer2D.Rasterizer2D_drawRectangle(Login.loginBoxX + 180 - 152, var4, 304, 34, 9179409);
				Rasterizer2D.Rasterizer2D_drawRectangle(Login.loginBoxX + 180 - 151, var4 + 1, 302, 32, 0);
				Rasterizer2D.Rasterizer2D_fillRectangle(Login.loginBoxX + 180 - 150, var4 + 2,
						Login.Login_loadingPercent * 3, 30, 9179409);
				Rasterizer2D.Rasterizer2D_fillRectangle(Login.Login_loadingPercent * 3 + (Login.loginBoxX + 180 - 150),
						var4 + 2, 300 - Login.Login_loadingPercent * 3, 30, 0);
			...
			if (Client.gameState == 20) {
				class481.titleboxSprite.drawAt(Login.loginBoxX + 180 - class481.titleboxSprite.subWidth / 2,
						271 - class481.titleboxSprite.subHeight / 2);
				var3 = 201;
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var5 = UserComparator10.method2879(); var0.stringWidth(var5) > var25; var5 = var5.substring(0,
							var5.length() - 1)) {
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						for (var5 = UserComparator10.method2879(); var0.stringWidth(var5) > var25; var5 = var5
								.substring(1)) {
						}

						var0.draw(AbstractFont.escapeBrackets(var5)
								+ (Login.currentLoginField == 0 & Client.cycle % 40 < 20
										? Strings.colorStartTag(16776960) + "|"
										: ""),
								class485.loginBoxCenter - 70, var3, 16777215, 0);
						var3 += 15;
						var7 = Login.Login_password;
						var6 = GrandExchangeOfferAgeComparator.method6832('*', var7.length());
						...
						var0.draw("Password: " + var8
								+ (Login.currentLoginField == 1 & Client.cycle % 40 < 20
										? Strings.colorStartTag(16776960) + "|"
										: ""),
								class485.loginBoxCenter - 108, var3, 16777215, 0);
						var3 += 15;
						var26 = 277;
						var9 = class485.loginBoxCenter + -117;
						boolean var11 = Client.Login_isUsernameRemembered;
						boolean var12 = Login.field947;
						var10 = var11 ? (var12 ? NPC.field1290 : class177.options_buttons_2Sprite)
								: (var12 ? DynamicObject.field1008 : class104.options_buttons_0Sprite);
						...
						IndexedSprite var14 = var15 ? (var16 ? NPC.field1290 : class177.options_buttons_2Sprite)
								: (var16 ? DynamicObject.field1008 : class104.options_buttons_0Sprite);
						...
						FriendsList.field4572 = new Bounds(class485.loginBoxCenter, var26,
								var1.stringWidth(WorldMapDecorationType.field3787), 11);
						Calendar.field3770 = new Bounds(class485.loginBoxCenter, var26,
								var1.stringWidth("Still having trouble logging in?"), 11);
						var1.drawCentered(WorldMapDecorationType.field3787, class485.loginBoxCenter, var26, 16777215,
								0);
					} else if (Login.loginIndex == 3) {
						var26 = 201;
						var0.drawCentered("Incorrect username or password.", Login.loginBoxX + 180, var26, 16776960, 0);
						var3 = var26 + 20;
						var1.drawCentered("If you have upgraded to a Jagex Account, you", Login.loginBoxX + 180, var3,
								16776960, 0);
						var3 += 20;
						var1.drawCentered(
								"need to log in using the <u=ffd200><col=ffd200>Jagex Launcher</col></u> instead.",
								Login.loginBoxX + 180, var3, 16776960, 0);
						var3 += 15;
						...
						var6 = GrandExchangeOfferAgeComparator.method6832('*', var7.length());
						var0.draw(var5 + var6 + (Client.cycle % 40 < 20 ? Strings.colorStartTag(16776960) + "|" : ""),
								Login.loginBoxX + 180 - 108, var3, 16777215, 0);
						var3 -= 8;
						...
						if (Login.loginIndex == 5) {
							...
							var0.draw(
									AbstractFont.escapeBrackets(var5)
											+ (Client.cycle % 40 < 20 ? Strings.colorStartTag(16776960) + "|" : ""),
									Login.loginBoxX + 180 - 34, var3, 16777215, 0);
							var3 += 15;
							...
							var21 = 356;
							var1.drawCentered("Still having trouble logging in?", class485.loginBoxCenter, var21,
									268435455, 0);
							...
							if (class112.field1401 && !Client.onMobile) {
								...
								for (var19 = 0; var19 < 8; ++var19) {
									...
									var0.draw(
											(Login.field938[var19] == null ? "" : Login.field938[var19])
													+ (var31 ? Strings.colorStartTag(16776960) + "|" : ""),
											var4 + 10, var3 + 27, 16777215, 0);
									if (var19 != 1 && var19 != 3) {
										var4 += 35;
									} else {
										var4 += 50;
								...
								var26 = 216;
								var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var26,
										16776960, 0);
								var3 = var26 + 15;
								var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180, var3,
										16776960, 0);
								var3 += 15;
								var2.drawCentered("setting your date of birth.", Login.loginBoxX + 180, var3, 16776960,
										0);
								var3 += 15;
								var4 = Login.loginBoxX + 180 - 80;
								var19 = 321;
							...
							if (Login.loginIndex == 8) {
								var26 = 216;
								var0.drawCentered("Sorry, but your account is not eligible to play.",
										Login.loginBoxX + 180, var26, 16776960, 0);
								var3 = var26 + 15;
								var2.drawCentered("For more information, please take a look at", Login.loginBoxX + 180,
										var3, 16776960, 0);
								var3 += 15;
								...
								var25 = 216;
								var2.drawCentered("Before using this app, please read and accept our", var3, var25,
										16777215, 0);
								var4 = var25 + 17;
								var2.drawCentered(
										"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
										var3, var4, 16777215, 0);
								var4 += 17;
								var2.drawCentered("<col=ffd200>agreement (EULA)</col>.", var3, var4, 16777215, 0);
								var4 += 17;
								var2.drawCentered("By accepting, you agree to these documents.", var3, var4, 16777215,
										0);
								...
								var26 = 231;
								var2.drawCentered("You must accept our terms of use, privacy policy,",
										Login.loginBoxX + 180, var26, 16777215, 0);
								var3 = var26 + 20;
								var2.drawCentered("and end user licence agreement to continue.", Login.loginBoxX + 180,
										var3, 16777215, 0);
								var4 = Login.loginBoxX + 180;
								var26 = 311;
			...
			SpriteMask.title_muteSprite[class10.clientPreferences.method2437() ? 1 : 0]
					.drawAt(Login.xPadding + 765 - 40, 463);
			if (Client.gameState > 5 && Language.Language_EN == TriBool.clientLanguage) {
				if (class19.field97 != null) {
					...
					var0.drawCentered("World" + " " + Client.worldId, var33 / 2 + var3, var34 / 2 + var25 - 2, 16777215,
							0);
					...
					class19.field97 = WorldMapRectangle.SpriteBuffer_getIndexedSpriteByName(class180.archive8,
							"sl_button", "");
				}
			}
	...
	static final void method3561(int var0, int var1) {
		...
		if (MusicPatchNode.cameraPitch < var0) {
			MusicPatchNode.cameraPitch = (var0 - MusicPatchNode.cameraPitch) * class209.field2322 / 1000
					+ MusicPatchNode.cameraPitch + BufferedSource.field4636;
			if (MusicPatchNode.cameraPitch > var0) {
				MusicPatchNode.cameraPitch = var0;
			}
		} else if (MusicPatchNode.cameraPitch > var0) {
			MusicPatchNode.cameraPitch -= (MusicPatchNode.cameraPitch - var0) * class209.field2322 / 1000
					+ BufferedSource.field4636;
			if (MusicPatchNode.cameraPitch < var0) {
				MusicPatchNode.cameraPitch = var0;
			}
		}
		...
		if (var5 != null) {
			...
			if (var8) {
				if (class60.method1131(StudioGame.getWidgetFlags(var5), var0 - 1)) {
					...
					if (var0 == 1) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON1,
					...
					if (var0 == 2) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON2,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 3) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON3,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 4) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON4,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 5) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON5,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 6) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON6,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 7) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON7,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 8) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON8,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 9) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON9,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
					...
					if (var0 == 10) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.IF_BUTTON10,
								Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
