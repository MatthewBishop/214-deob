		...
		if ((var0 == 100 || var0 < 100 && var1) && ByteArrayPool_smallCount > 0) {
			...
			if (JagexCache.ByteArrayPool_arrays != null) {
				for (var2 = 0; var2 < class152.ByteArrayPool_alternativeSizes.length; ++var2) {
					if ((class152.ByteArrayPool_alternativeSizes[var2] == var0
							|| var0 < class152.ByteArrayPool_alternativeSizes[var2] && var1)
							&& PendingSpawn.ByteArrayPool_altSizeArrayCounts[var2] > 0) {
			...
			if (var1 && class152.ByteArrayPool_alternativeSizes != null) {
				for (var2 = 0; var2 < class152.ByteArrayPool_alternativeSizes.length; ++var2) {
					if (var0 <= class152.ByteArrayPool_alternativeSizes[var2]
							&& PendingSpawn.ByteArrayPool_altSizeArrayCounts[var2] < JagexCache.ByteArrayPool_arrays[var2].length) {
		...
		if (var0 == ScriptOpcodes.CC_GETSCROLLX) {
			...
			if (var0 == ScriptOpcodes.CC_GETTEXT) {
				if (var3.type == 12) {
					...
					if (var7 != null) {
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = var7
								.method6163().method7267();
						return 1;
					}
				}
				...
				if (var0 == 1618) {
					...
					var7 = var3.method6380();
					Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = var7 != null
							? var7.method6105().method7267()
							: "";
					return 1;
				} else if (var0 == 1620) {
					var4 = var3.method6381();
