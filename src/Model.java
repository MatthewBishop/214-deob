...
public class Model extends Renderable {
	...
	void method4774(Model var1) {
		...
		if (this.faceRenderPriorities == null
				&& (var1.faceRenderPriorities != null || this.field2706 != var1.field2706)) {
	...
	public void method4782(Model var1) {
		if (var1 != null) {
			...
			for (var2 = 0; var2 < var1.indicesCount; ++var2) {
				...
				if (this.faceRenderPriorities != null) {
					this.faceRenderPriorities[this.indicesCount] = var1.faceRenderPriorities != null
							? var1.faceRenderPriorities[var2]
							: var1.field2706;
				}
	...
	void calculateBoundingBox(int var1) {
		if (!this.aabb.containsKey(var1)) {
			...
			AABB var14 = new AABB((var5 + var2) / 2, (var6 + var3) / 2, (var7 + var4) / 2, (var5 - var2 + 1) / 2,
					(var6 - var3 + 1) / 2, (var7 - var4 + 1) / 2);
			boolean var15 = true;
	...
	public void calculateBoundsCylinder() {
		if (this.boundsType != 1) {
			...
			this.radius = (int) (Math.sqrt((double) (this.xzRadius * this.xzRadius + super.height * super.height))
					+ 0.99);
			this.diameter = this.radius
					+ (int) (Math.sqrt((double) (this.xzRadius * this.xzRadius + this.bottomY * this.bottomY)) + 0.99);
		}
	}
		...
		if (this.vertexLabels != null) {
			if (var2 != -1) {
				...
				for (int var5 = 0; var5 < var3.transformCount; ++var5) {
					...
					this.transform(var4.transformTypes[var6], var4.labels[var6], var3.transformXs[var5],
							var3.transformYs[var5], var3.transformZs[var5]);
				}
	...
	void method4786(class136 var1, int var2) {
		...
		for (int var4 = 0; var4 < var3.count; ++var4) {
			...
			if (var5 == 5 && var1.field1583 != null && var1.field1583[var4] != null && var1.field1583[var4][0] != null
					&& this.faceLabelsAlpha != null && this.faceAlphas != null) {
			...
			if (var5 != null && var4 != -1) {
				...
				for (var11 = 0; var11 < var6.transformCount; ++var11) {
					...
					if (var12 != var10 || var8.transformTypes[var12] == 0) {
						this.transform(var8.transformTypes[var12], var8.labels[var12], var6.transformXs[var11],
								var6.transformYs[var11], var6.transformZs[var11]);
					}
				}
				...
				for (var11 = 0; var11 < var7.transformCount; ++var11) {
					...
					if (var12 == var10 || var8.transformTypes[var12] == 0) {
						this.transform(var8.transformTypes[var12], var8.labels[var12], var7.transformXs[var11],
								var7.transformYs[var11], var7.transformZs[var11]);
					}
				}
			...
			for (int var9 = 0; var9 < var5.transformCount; ++var9) {
				...
				if (var4) {
					if (var10 == var8 || var6.transformTypes[var10] == 0) {
						this.transform(var6.transformTypes[var10], var6.labels[var10], var5.transformXs[var9],
								var5.transformYs[var9], var5.transformZs[var9]);
					}
			...
			for (var7 = 0; var7 < this.indicesCount; var7 = (char) (var7 + 1)) {
				if (this.faceColors3[var7] != -2) {
					...
					if (!var1 || var11 != -5000 && var12 != -5000 && var28 != -5000) {
						if (var2 && ClientPacket.method5662(modelViewportYs[var8], modelViewportYs[var9],
								modelViewportYs[var10], var11, var12, var28, var6)) {
							class12.method163(var4);
							var2 = false;
						}

						if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9])
								- (var28 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) {
							field2724[var7] = false;
							var29 = Rasterizer3D.method4388();
							if (var11 >= 0 && var12 >= 0 && var28 >= 0 && var11 <= var29 && var12 <= var29
									&& var28 <= var29) {
	...
	final void drawFace(int var1) {
		if (field2724[var1]) {
			...
			this.method4779(var1, modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
					modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], field2692[var2],
					field2692[var3], field2692[var4], this.faceColors1[var1], this.faceColors2[var1],
	...
	final void method4779(int var1, int var2, int var3, int var4, int var5, int var6, int var7, float var8, float var9,
			float var10, int var11, int var12, int var13) {
		if (this.faceTextures != null && this.faceTextures[var1] != -1) {
			...
			if (this.faceColors3[var1] == -1) {
				Rasterizer3D.method4391(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var11, var11,
						field2717[var18], field2717[var15], field2717[var16], field2730[var18], field2730[var15],
						field2730[var16], field2731[var18], field2731[var15], field2731[var16],
						this.faceTextures[var1]);
			} else {
				Rasterizer3D.method4391(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13,
						field2717[var18], field2717[var15], field2717[var16], field2730[var18], field2730[var15],
						field2730[var16], field2731[var18], field2731[var15], field2731[var16],
						this.faceTextures[var1]);
			}
			...
			if (this.faceColors3[var1] == -1 && var14) {
				Rasterizer3D.method4394(var2, var3, var4, var5, var6, var7, var8, var9, var10,
						field2752[this.faceColors1[var1]], this.overrideHue, this.overrideSaturation,
						this.overrideLuminance, this.overrideAmount);
			} else if (this.faceColors3[var1] == -1) {
				Rasterizer3D.method4390(var2, var3, var4, var5, var6, var7, var8, var9, var10,
						field2752[this.faceColors1[var1]]);
			} else if (var14) {
				Rasterizer3D.method4393(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13,
						this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount);
			} else {
	...
	final void method4862(int var1) {
		...
		if (var8 >= 50) {
			...
			if (var10 >= 50) {
				...
				field2740[var4] = var2
						+ (var11 + ((field2717[var7] - var11) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
				field2741[var4] = var3
						+ (var12 + ((field2730[var7] - var12) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
			...
			if (var9 >= 50) {
				...
				field2740[var4] = var2
						+ (var11 + ((field2717[var6] - var11) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
				field2741[var4] = var3
						+ (var12 + ((field2730[var6] - var12) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
				field2743[var4] = field2718;
		...
		if (var9 >= 50) {
			...
			if (var8 >= 50) {
				...
				field2740[var4] = var2
						+ (var11 + ((field2717[var5] - var11) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
				field2741[var4] = var3
						+ (var12 + ((field2730[var5] - var12) * var14 >> 16)) * Rasterizer3D.get3dZoom() / 50;
				field2743[var4] = field2718;
		...
		if (var4 == 3) {
			...
			this.method4779(var1, var14, var15, var16, var11, var12, var13, var17, var18, var19, field2744[0],
					field2744[1], field2744[2]);
		}

		if (var4 == 4) {
			if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > var20 || var12 > var20 || var13 > var20
					|| field2740[3] < 0 || field2740[3] > var20) {
				Rasterizer3D.clips.field2798 = true;
			}
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				if (this.faceColors3[var1] == -1) {
					Rasterizer3D.method4391(var14, var15, var16, var11, var12, var13, var17, var18, var19,
							this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field2717[var25],
							field2717[var22], field2717[var23], field2730[var25], field2730[var22], field2730[var23],
							field2731[var25], field2731[var22], field2731[var23], var26);
					Rasterizer3D.method4391(var14, var16, field2741[3], var11, var13, field2740[3], var17, var19,
							field2743[3], this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1],
							field2717[var25], field2717[var22], field2717[var23], field2730[var25], field2730[var22],
							field2730[var23], field2731[var25], field2731[var22], field2731[var23], var26);
				} else {
					Rasterizer3D.method4391(var14, var15, var16, var11, var12, var13, var17, var18, var19, field2744[0],
							field2744[1], field2744[2], field2717[var25], field2717[var22], field2717[var23],
							field2730[var25], field2730[var22], field2730[var23], field2731[var25], field2731[var22],
							field2731[var23], var26);
					Rasterizer3D.method4391(var14, var16, field2741[3], var11, var13, field2740[3], var17, var19,
							field2743[3], field2744[0], field2744[2], field2744[3], field2717[var25], field2717[var22],
							field2717[var23], field2730[var25], field2730[var22], field2730[var23], field2731[var25],
							field2731[var22], field2731[var23], var26);
				}
			} else {
				boolean var21 = this.method4803(var1);
				if (this.faceColors3[var1] == -1 && var21) {
					var22 = field2752[this.faceColors1[var1]];
					Rasterizer3D.method4394(var14, var15, var16, var11, var12, var13, var17, var18, var19, var22,
							this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount);
					Rasterizer3D.method4394(var14, var16, field2741[3], var11, var13, field2740[3], var17, var19,
							field2743[3], var22, this.overrideHue, this.overrideSaturation, this.overrideLuminance,
							this.overrideAmount);
				} else if (this.faceColors3[var1] == -1) {
					var22 = field2752[this.faceColors1[var1]];
					Rasterizer3D.method4390(var14, var15, var16, var11, var12, var13, var17, var18, var19, var22);
					Rasterizer3D.method4390(var14, var16, field2741[3], var11, var13, field2740[3], var17, var19,
							field2743[3], var22);
				} else if (var21) {
					Rasterizer3D.method4393(var14, var15, var16, var11, var12, var13, var17, var18, var19, field2744[0],
							field2744[1], field2744[2], this.overrideHue, this.overrideLuminance,
							this.overrideSaturation, this.overrideAmount);
					Rasterizer3D.method4393(var14, var16, field2741[3], var11, var13, field2740[3], 0.0F, 0.0F, 0.0F,
							field2744[0], field2744[2], field2744[3], this.overrideHue, this.overrideLuminance,
							this.overrideSaturation, this.overrideAmount);
				} else {
					Rasterizer3D.method4389(var14, var15, var16, var11, var12, var13, var17, var18, var19, field2744[0],
							field2744[1], field2744[2]);
					Rasterizer3D.method4389(var14, var16, field2741[3], var11, var13, field2740[3], var17, var19,
							field2743[3], field2744[0], field2744[2], field2744[3]);
				}
			}
		}
	...
	void method4806(int var1, class438 var2) {
		...
		float var6 = 1.0F;
		this.verticesX[var1] = (int) (var2.field4685[0] * var3 + var2.field4685[4] * var4 + var2.field4685[8] * var5
				+ var2.field4685[12] * var6);
		this.verticesY[var1] = -((int) (var2.field4685[1] * var3 + var2.field4685[5] * var4 + var2.field4685[9] * var5
				+ var2.field4685[13] * var6));
		this.verticesZ[var1] = -((int) (var2.field4685[2] * var3 + var2.field4685[6] * var4 + var2.field4685[10] * var5
				+ var2.field4685[14] * var6));
	}
									...
									if (!var38) {
										...
										if (Math.abs(var46) > var43 + class393.field4436) {
											...
											var36 = false;
												...
												.abs(var48 * class1.field4 - var47 * VarpDefinition.field1905) > var45
														* class337.field3782 + var44 * class136.field1585) {
											var36 = false;
										} else if (Math.abs(var46 * VarpDefinition.field1905
												- var48 * ViewportMouse.field2762) > var45 * class393.field4436
														+ var43 * class136.field1585) {
											var36 = false;
										} else if (Math.abs(var47 * ViewportMouse.field2762
												- var46 * class1.field4) > var44 * class393.field4436
														+ var43 * class337.field3782) {
											var36 = false;
										} else {
											var36 = true;
										}
