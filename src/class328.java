public class class328 {
	...
	public static final short[][] field3580 = new short[][] {
			{ 6798, 107, 10283, 16, 4797, 7744, 5799, 4634, -31839, 22433, 2983, -11343, 8, 5281, 10438, 3650, -27322,
					-21845, 200, 571, 908, 21830, 28946, -15701, -14010, -22122, 937, 8130, -13422, 30385 },
	...
	public static final short[][] field3583 = new short[][] {
			{ 6554, 115, 10304, 28, 5702, 7756, 5681, 4510, -31835, 22437, 2859, -11339, 16, 5157, 10446, 3658, -27314,
					-21965, 472, 580, 784, 21966, 28950, -15697, -14002, -22116, 945, 8144, -13414, 30389 },
	...
	public static int method6347(int var0, int var1, int var2, RouteStrategy var3, CollisionMap var4, boolean var5,
			int[] var6, int[] var7, class215 var8) {
		var8.method4253();
		...
		if (var2 == 1) {
			...
			while (true) {
				...
				if (var26 > 0 && var27 > 0 && var20[var26 - 1][var27 - 1] == 0
						&& (var32[var33 - 1][var34 - 1] & 19136782) == 0 && (var32[var33 - 1][var34] & 19136776) == 0
						&& (var32[var33][var34 - 1] & 19136770) == 0) {
					var21[var30] = var24 - 1;
					var22[var30] = var25 - 1;
					var30 = var30 + 1 & var23;
				...
				if (var26 < var17 - 1 && var27 > 0 && var20[var26 + 1][var27 - 1] == 0
						&& (var32[var33 + 1][var34 - 1] & 19136899) == 0 && (var32[var33 + 1][var34] & 19136896) == 0
						&& (var32[var33][var34 - 1] & 19136770) == 0) {
					var21[var30] = var24 + 1;
					var22[var30] = var25 - 1;
					var30 = var30 + 1 & var23;
				...
				if (var26 > 0 && var27 < var18 - 1 && var20[var26 - 1][var27 + 1] == 0
						&& (var32[var33 - 1][var34 + 1] & 19136824) == 0 && (var32[var33 - 1][var34] & 19136776) == 0
						&& (var32[var33][var34 + 1] & 19136800) == 0) {
					var21[var30] = var24 - 1;
					var22[var30] = var25 + 1;
					var30 = var30 + 1 & var23;
				...
				if (var26 < var17 - 1 && var27 < var18 - 1 && var20[var26 + 1][var27 + 1] == 0
						&& (var32[var33 + 1][var34 + 1] & 19136992) == 0 && (var32[var33 + 1][var34] & 19136896) == 0
						&& (var32[var33][var34 + 1] & 19136800) == 0) {
					var21[var30] = var24 + 1;
					var22[var30] = var25 + 1;
					var30 = var30 + 1 & var23;
			...
			if (var2 == 2) {
				...
				while (true) {
					...
					var35 = var19[var26][var27] + 1;
					if (var26 > 0 && var20[var26 - 1][var27] == 0 && (var32[var33 - 1][var34] & 19136782) == 0
							&& (var32[var33 - 1][var34 + 1] & 19136824) == 0) {
						var21[var30] = var24 - 1;
						var22[var30] = var25;
						var30 = var30 + 1 & var23;
						var20[var26 - 1][var27] = 2;
					...
					if (var26 < var17 - 2 && var20[var26 + 1][var27] == 0 && (var32[var33 + 2][var34] & 19136899) == 0
							&& (var32[var33 + 2][var34 + 1] & 19136992) == 0) {
						var21[var30] = var24 + 1;
						var22[var30] = var25;
						var30 = var30 + 1 & var23;
						var20[var26 + 1][var27] = 8;
					...
					if (var27 > 0 && var20[var26][var27 - 1] == 0 && (var32[var33][var34 - 1] & 19136782) == 0
							&& (var32[var33 + 1][var34 - 1] & 19136899) == 0) {
						var21[var30] = var24;
						var22[var30] = var25 - 1;
						var30 = var30 + 1 & var23;
						var20[var26][var27 - 1] = 1;
					...
					if (var27 < var18 - 2 && var20[var26][var27 + 1] == 0 && (var32[var33][var34 + 2] & 19136824) == 0
							&& (var32[var33 + 1][var34 + 2] & 19136992) == 0) {
						var21[var30] = var24;
						var22[var30] = var25 + 1;
						var30 = var30 + 1 & var23;
						var20[var26][var27 + 1] = 4;
					...
					if (var26 > 0 && var27 > 0 && var20[var26 - 1][var27 - 1] == 0
							&& (var32[var33 - 1][var34] & 19136830) == 0
							&& (var32[var33 - 1][var34 - 1] & 19136782) == 0
							&& (var32[var33][var34 - 1] & 19136911) == 0) {
						var21[var30] = var24 - 1;
						var22[var30] = var25 - 1;
						var30 = var30 + 1 & var23;
						var20[var26 - 1][var27 - 1] = 3;
					...
					if (var26 < var17 - 2 && var27 > 0 && var20[var26 + 1][var27 - 1] == 0
							&& (var32[var33 + 1][var34 - 1] & 19136911) == 0
							&& (var32[var33 + 2][var34 - 1] & 19136899) == 0
							&& (var32[var33 + 2][var34] & 19136995) == 0) {
						var21[var30] = var24 + 1;
						var22[var30] = var25 - 1;
						var30 = var30 + 1 & var23;
						var20[var26 + 1][var27 - 1] = 9;
					...
					if (var26 > 0 && var27 < var18 - 2 && var20[var26 - 1][var27 + 1] == 0
							&& (var32[var33 - 1][var34 + 1] & 19136830) == 0
							&& (var32[var33 - 1][var34 + 2] & 19136824) == 0
							&& (var32[var33][var34 + 2] & 19137016) == 0) {
						var21[var30] = var24 - 1;
						var22[var30] = var25 + 1;
						var30 = var30 + 1 & var23;
						var20[var26 - 1][var27 + 1] = 6;
					...
					if (var26 < var17 - 2 && var27 < var18 - 2 && var20[var26 + 1][var27 + 1] == 0
							&& (var32[var33 + 1][var34 + 2] & 19137016) == 0
							&& (var32[var33 + 2][var34 + 2] & 19136992) == 0
							&& (var32[var33 + 2][var34 + 1] & 19136995) == 0) {
						var21[var30] = var24 + 1;
						var22[var30] = var25 + 1;
						var30 = var30 + 1 & var23;
						var20[var26 + 1][var27 + 1] = 12;
					...
					label752: while (true) {
							...
							do {
								do {
									label729: do {
										...
										var35 = var19[var26][var27] + 1;
										if (var26 > 0 && var20[var26 - 1][var27] == 0
												&& (var32[var33 - 1][var34] & 19136782) == 0
												&& (var32[var33 - 1][var34 + var2 - 1] & 19136824) == 0) {
											var36 = 1;
										...
										if (var26 < var17 - var2 && var20[var26 + 1][var27] == 0
												&& (var32[var33 + var2][var34] & 19136899) == 0
												&& (var32[var33 + var2][var34 + var2 - 1] & 19136992) == 0) {
											var36 = 1;
										...
										if (var27 > 0 && var20[var26][var27 - 1] == 0
												&& (var32[var33][var34 - 1] & 19136782) == 0
												&& (var32[var33 + var2 - 1][var34 - 1] & 19136899) == 0) {
											var36 = 1;
										...
										if (var27 < var18 - var2 && var20[var26][var27 + 1] == 0
												&& (var32[var33][var34 + var2] & 19136824) == 0
												&& (var32[var33 + var2 - 1][var34 + var2] & 19136992) == 0) {
											var36 = 1;
										...
										if (var26 > 0 && var27 > 0 && var20[var26 - 1][var27 - 1] == 0
											...
											while (true) {
												...
												if ((var32[var33 - 1][var36 + (var34 - 1)] & 19136830) != 0
														|| (var32[var36 + (var33 - 1)][var34 - 1] & 19136911) != 0) {
													break;
												}
										...
										if (var26 < var17 - var2 && var27 > 0 && var20[var26 + 1][var27 - 1] == 0
												&& (var32[var33 + var2][var34 - 1] & 19136899) == 0) {
											var36 = 1;
											...
											while (true) {
												...
												if ((var32[var33 + var2][var36 + (var34 - 1)] & 19136995) != 0
														|| (var32[var36 + var33][var34 - 1] & 19136911) != 0) {
													break;
												}
										...
										if (var26 > 0 && var27 < var18 - var2 && var20[var26 - 1][var27 + 1] == 0
												&& (var32[var33 - 1][var34 + var2] & 19136824) == 0) {
											for (var36 = 1; var36 < var2; ++var36) {
												if ((var32[var33 - 1][var36 + var34] & 19136830) != 0
														|| (var32[var36 + (var33 - 1)][var34 + var2] & 19137016) != 0) {
													continue label729;
												}
											}
						...
						for (var36 = 1; var36 < var2; ++var36) {
							if ((var32[var33 + var36][var34 + var2] & 19137016) != 0
									|| (var32[var33 + var2][var34 + var36] & 19136995) != 0) {
								continue label752;
							}
						}
		...
		if (var0 == var18 && var37 == var1) {
			...
			for (var39 = var40 = var12[var18 - var42][var37 - var17]; var0 != var18
					|| var37 != var1; var39 = var12[var18 - var42][var37 - var17]) {
				if (var39 != var40) {
					var40 = var39;
					var13[var38] = var18;
					var14[var38++] = var37;
