...
public class PlayerComposition {
	...
	static {
		equipmentIndices = new int[] { class208.field2304.field2315, class208.field2312.field2315,
				class208.field2301.field2315, class208.field2307.field2315, class208.field2309.field2315,
				class208.field2308.field2315, class208.field2311.field2315 };
	...
	PlayerComposition(PlayerComposition var1) {
		...
		PlayerCompositionColorTextureOverride[] var4 = (PlayerCompositionColorTextureOverride[]) (var1.playerCompositionColorTextureOverrides != null
				? (PlayerCompositionColorTextureOverride[]) Arrays.copyOf(var1.playerCompositionColorTextureOverrides,
						var1.playerCompositionColorTextureOverrides.length)
				: null);
	...
	public void method6010(int[] var1, int[] var2, PlayerCompositionColorTextureOverride[] var3, boolean var4,
				...
				if (var18 == null) {
						...
						if (var13 >= 512) {
							...
							if (var15 != null) {
								if (this.playerCompositionColorTextureOverrides != null) {
									...
									if (var16 != null) {
										int var17;
										if (var16.playerCompositionRecolorTo != null && var22.recolorFrom != null
												&& var22.recolorTo.length == var16.playerCompositionRecolorTo.length) {
											for (var17 = 0; var17 < var22.recolorFrom.length; ++var17) {
												var15.recolor(var22.recolorTo[var17],
														var16.playerCompositionRecolorTo[var17]);
											}
										}

										if (var16.playerCompositionRetextureTo != null && var22.retextureFrom != null
												&& var16.playerCompositionRetextureTo.length == var22.retextureTo.length) {
											for (var17 = 0; var17 < var22.retextureFrom.length; ++var17) {
												var15.retexture(var22.retextureTo[var17],
														var16.playerCompositionRetextureTo[var17]);
											}
										}
									}
								}
					...
					for (var13 = 0; var13 < 5; ++var13) {
						if (this.bodyColors[var13] < class13.field65[var13].length) {
							var20.recolor(WorldMapSection1.field3036[var13],
									class13.field65[var13][this.bodyColors[var13]]);
						}

						if (this.bodyColors[var13] < class209.field2326[var13].length) {
							var20.recolor(GrandExchangeEvent.field4312[var13],
									class209.field2326[var13][this.bodyColors[var13]]);
						}
					}
			...
			if (var1) {
				...
				for (var5 = 0; var5 < 5; ++var5) {
					...
					if (this.bodyColors[var5] < class209.field2326[var5].length) {
						var8.recolor(GrandExchangeEvent.field4312[var5],
								class209.field2326[var5][this.bodyColors[var5]]);
					}
				}
	...
	public int getChatHeadId() {
		return this.npcTransformId == -1
				...
				: 305419896 + Bounds.getNpcDefinition(this.npcTransformId).id;
	}
	...
	static final void method6009(Player var0, int var1, int var2, class216 var3) {
		...
		if (var4 >= var6 && var4 < 104 - var6 && var5 >= var6 && var5 < 104 - var6) {
			if (var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) {
				...
				int var7 = class328.method6347(var4, var5, var8, var9, var10, true, var11, var12,
						class135.field1579[0]);
				int var13 = var7;
				if (var7 >= 1) {
