...
public class SpotAnimationDefinition extends DualNode {
	...
	public static PacketBufferNode method3778(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = ObjectComposition.getPacketBufferNode(ClientPacket.field3138,
		...
		if (var0 == ScriptOpcodes.FRIEND_COUNT) {
			if (ApproximateRouteStrategy.friendSystem.field835 == 0) {
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
						- 1] = ApproximateRouteStrategy.friendSystem.friendsList.getSize();
			}
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (ApproximateRouteStrategy.friendSystem.method1803() && var3 >= 0
						&& var3 < ApproximateRouteStrategy.friendSystem.friendsList.getSize()) {
				...
				if (ApproximateRouteStrategy.friendSystem.method1803() && var3 >= 0
						&& var3 < ApproximateRouteStrategy.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ((Buddy) ApproximateRouteStrategy.friendSystem.friendsList.get(var3)).world;
				} else {
				...
				if (ApproximateRouteStrategy.friendSystem.method1803() && var3 >= 0
						&& var3 < ApproximateRouteStrategy.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ((Buddy) ApproximateRouteStrategy.friendSystem.friendsList.get(var3)).rank;
				} else {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
				}
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ApproximateRouteStrategy.friendSystem
									.isFriended(new Username(var5, WorldMapScaleHandler.loginType), false) ? 1 : 0;
					return 1;
				} else if (var0 == ScriptOpcodes.CLAN_GETCHATDISPLAYNAME) {
					if (class406.friendsChat != null) {
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
								- 1] = class406.friendsChat.name;
					} else {
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class406.friendsChat != null) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class406.friendsChat.getSize();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()) {
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize
								- 1] = class406.friendsChat.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++class149.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ((Buddy) class406.friendsChat.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ((Buddy) class406.friendsChat.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = class406.friendsChat != null ? class406.friendsChat.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = class406.friendsChat != null ? class406.friendsChat.rank : 0;
					return 1;
					...
					if (!ApproximateRouteStrategy.friendSystem.method1803()) {
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ApproximateRouteStrategy.friendSystem.ignoreList.getSize();
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (ApproximateRouteStrategy.friendSystem.method1803() && var3 >= 0
							&& var3 < ApproximateRouteStrategy.friendSystem.ignoreList.getSize()) {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ApproximateRouteStrategy.friendSystem
									.isIgnored(new Username(var5, WorldMapScaleHandler.loginType)) ? 1 : 0;
					return 1;
				} else if (var0 == ScriptOpcodes.CLAN_ISSELF) {
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()
							&& class406.friendsChat.get(var3).getUsername().equals(Projectile.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()
							&& ((ClanMate) class406.friendsChat.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							ApproximateRouteStrategy.friendSystem.friendsList
									.addComparator(new BuddyRankComparator(var7));
							return 1;
						} else if (var0 == 3657) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class406.friendsChat != null) {
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class406.friendsChat != null && var3 < class406.friendsChat.getSize()
							&& ((ClanMate) class406.friendsChat.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
