public class WorldMapIcon_0 extends AbstractWorldMapIcon {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7,
			int var8) {
		if (var2 >= 2000) {
			var2 -= 2000;
		}
		...
		if (var2 == 24) {
			...
			if (var17 != null) {
				...
				if (var12) {
					var13 = ObjectComposition.getPacketBufferNode(ClientPacket.WIDGET_TYPE,
		...
		if (var2 == 25) {
			...
			if (var17 != null) {
				...
				FriendLoginUpdate.selectSpell(var1, var0,
						LoginScreenAnimation.Widget_unpackTargetMask(StudioGame.getWidgetFlags(var17)), var4);
				...
				if (var17.isIf3) {
					...
					Client.selectedSpellName = Strings.colorStartTag(65280) + var17.field3731
							+ Strings.colorStartTag(16777215);
				}
			}
			...
			if (var2 == 1003) {
				...
				if (var15 != null) {
					...
					if (var19 != null) {
						var13 = ObjectComposition.getPacketBufferNode(ClientPacket.OPNPCE,
								Client.packetWriter.isaacCipher);
			...
			if (var2 == 48) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = ObjectComposition.getPacketBufferNode(ClientPacket.OPPLAYER5,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeShortAddLE(var3);
					var10.packetBuffer.writeByte(Client.field739.method4134(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
